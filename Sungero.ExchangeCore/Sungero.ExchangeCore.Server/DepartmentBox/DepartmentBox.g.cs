...
namespace Sungero.ExchangeCore.Server
{
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.IDepartmentBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.DepartmentBoxParentBoxPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("ParentBoxFiltering");
      ...
      {
        result = new global::Sungero.ExchangeCore.DepartmentBoxParentBoxPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).ParentBoxFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.ExchangeCore.IBoxBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.DepartmentBoxParentBoxSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("ParentBoxSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.ExchangeCore.DepartmentBoxParentBoxSearchPropertyFilteringServerHandler<TQueryEntity>().ParentBoxSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.IDepartmentBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.DepartmentBoxDepartmentPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.ExchangeCore.DepartmentBoxDepartmentPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).DepartmentFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.Company.IDepartment
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.DepartmentBoxDepartmentSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
      ...
      {
        result = new global::Sungero.ExchangeCore.DepartmentBoxDepartmentSearchPropertyFilteringServerHandler<TQueryEntity>().DepartmentSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.IDepartmentBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.DepartmentBoxRootBoxPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.ExchangeCore.DepartmentBoxRootBoxPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).RootBoxFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.ExchangeCore.IBusinessUnitBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.DepartmentBoxRootBoxSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
      ...
      {
        result = new global::Sungero.ExchangeCore.DepartmentBoxRootBoxSearchPropertyFilteringServerHandler<TQueryEntity>().RootBoxSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.ExchangeCore.Server.BoxBase, global::Sungero.ExchangeCore.IDepartmentBox, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.ExchangeCore.DepartmentBoxCreatingFromServerHandler", new object[] { (global::Sungero.ExchangeCore.IDepartmentBox)entitySource, this.Info });
      if (instance != null)
    ...
    protected void ParentBoxChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IDepartmentBoxSharedHandlers)this.SharedHandlers).ParentBoxChanged(args);
    }
    ...
    protected void DepartmentChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IDepartmentBoxSharedHandlers)this.SharedHandlers).DepartmentChanged(args);
    }
    ...
    protected void RootBoxChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IDepartmentBoxSharedHandlers)this.SharedHandlers).RootBoxChanged(args);
    }
    ...
    protected void ServiceIdChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IDepartmentBoxSharedHandlers)this.SharedHandlers).ServiceIdChanged(args);
    }
    ...
    protected void IsDeletedChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IDepartmentBoxSharedHandlers)this.SharedHandlers).IsDeletedChanged(args);
    }
    ...
    protected void ServiceNameChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IDepartmentBoxSharedHandlers)this.SharedHandlers).ServiceNameChanged(args);
    }
...
namespace Sungero.ExchangeCore.Functions
{
  internal static class DepartmentBox
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.Server.DepartmentBoxFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("CreateDepartmentBoxes",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.ExchangeCore.IBusinessUnitBox) }, null);
    global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { box });
      }
      else
      {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)departmentBox).FunctionsContainer.ServerFunctions;
    ...
    /// <redirect project="Sungero.ExchangeCore.Server" type="Sungero.ExchangeCore.Server.DepartmentBoxFunctions" />
    internal static  global::System.DateTime GetProcessingTaskDeadline(global::Sungero.ExchangeCore.IDepartmentBox departmentBox, global::Sungero.Company.IEmployee assignee)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)departmentBox).FunctionsContainer.ServerFunctions;
...
namespace Sungero.ExchangeCore.Server
{
  ...
  {
    public global::Sungero.Company.IBusinessUnit GetBusinessUnit(global::Sungero.ExchangeCore.IDepartmentBox departmentBox)
    {
      return global::Sungero.ExchangeCore.Functions.DepartmentBox.GetBusinessUnit(departmentBox);
    }
    public global::Sungero.Company.IDepartment GetDepartment(global::Sungero.ExchangeCore.IDepartmentBox departmentBox)
    {
      return global::Sungero.ExchangeCore.Functions.DepartmentBox.GetDepartment(departmentBox);
    }
    public global::Sungero.Company.IEmployee GetExchangeDocumentResponsible(global::Sungero.ExchangeCore.IDepartmentBox departmentBox, global::Sungero.Parties.ICounterparty counterparty, global::System.Collections.Generic.List<global::Sungero.Exchange.IExchangeDocumentInfo> infos)
    {
      return global::Sungero.ExchangeCore.Functions.DepartmentBox.GetExchangeDocumentResponsible(departmentBox, counterparty, infos);
    }
  }
}
