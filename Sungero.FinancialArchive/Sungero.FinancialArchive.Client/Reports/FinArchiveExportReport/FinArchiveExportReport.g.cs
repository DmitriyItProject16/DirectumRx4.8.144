...
namespace Sungero.FinancialArchive.Client
{
  public class FinArchiveExportReport : global::Sungero.Reporting.Client.Report, global::Sungero.FinancialArchive.IFinArchiveExportReport
  {
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.FinancialArchive.FinArchiveExportReportClientHandlers");
      this.Handlers = type != null
        ? global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this })
        : new global::Sungero.FinancialArchive.FinArchiveExportReportClientHandlers(this);
    }
  }
}
