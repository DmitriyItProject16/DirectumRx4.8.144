...
namespace Sungero.Parties.Client
{
      ...
      return new global::Sungero.Parties.Client.CounterpartyAccessRights(this);
        ...
        public virtual global::System.String ExternalId
        {
          ...
          set { this._ExternalId.Value = value; }
              ...
              protected global::Sungero.Domain.Client.INavigationProperty<global::Sungero.Parties.ICounterpartyKind> _Kind;

              public virtual global::Sungero.Parties.ICounterpartyKind Kind
              {
              get
              {
                return this._Kind.Value as global::Sungero.Parties.ICounterpartyKind;
              }

              set
              {
                (this._Kind as global::Sungero.Domain.Client.IProperty).Value = value;
              }
            }
  ...
  protected global::System.String ExternalIdValueInputHandler(global::System.String value)
  {
    ...
    ((global::Sungero.Parties.CounterpartyClientHandlers)this.Handlers).ExternalIdValueInput(args);
    return args.NewValue;
  }

  protected global::Sungero.Parties.ICounterpartyKind KindValueInputHandler(global::Sungero.Parties.ICounterpartyKind value)
  {
    var args = new global::Sungero.Parties.Client.CounterpartyKindValueInputEventArgs(this.Kind, value, this, this.Info.Properties.Kind);
    ((global::Sungero.Parties.CounterpartyClientHandlers)this.Handlers).KindValueInput(args);
    return args.NewValue;
  }
    ...
    #region Constructors
              ...
              protected virtual void InitKindNavigationProperty()
              {
                this._Kind = new global::Sungero.Domain.Client.NavigationProperty<global::Sungero.Parties.ICounterpartyKind>("Kind", this);
                this._Kind.ValueChanged += (sender, e) => { this.KindChangedHandler(); };
                this.AddProperty(this._Kind as global::Sungero.Domain.Client.IProperty);
              }
    ...
    public Counterparty()
    {
            ...
            this.InitKindNavigationProperty();
...
namespace Sungero.Parties.Client
{
    ...
    where T : class, global::Sungero.Parties.ICounterparty
  {
    #region Fields and properties
          ...
          private global::System.Windows.Input.ICommand _ShowDepartmentBoxesCommand;

          public global::System.Windows.Input.ICommand ShowDepartmentBoxesCommand
          {
            get
            {
              if (this._ShowDepartmentBoxesCommand == null)
                  this._ShowDepartmentBoxesCommand = new global::Sungero.Domain.Client.SingleChildEntityCommand<global::Sungero.Parties.ICounterpartyExchangeBoxes>("ShowDepartmentBoxes", this, this.ShowDepartmentBoxes, this.CanShowDepartmentBoxes);
              return this._ShowDepartmentBoxesCommand;
            }
          }
          private global::System.Windows.Input.ICommand _EditExchangeCommand;

          public global::System.Windows.Input.ICommand EditExchangeCommand
          {
            get
            {
              if (this._EditExchangeCommand == null)
                  this._EditExchangeCommand = new global::Sungero.Domain.Client.SingleChildEntityCommand<global::Sungero.Parties.ICounterpartyExchangeBoxes>("EditExchange", this, this.EditExchange, this.CanEditExchange);
              return this._EditExchangeCommand;
            }
          }
    ...
    #region Methods
            ...
            private bool CanShowDepartmentBoxes(global::Sungero.Domain.Shared.IChildEntity selectedEntity,
              global::Sungero.Domain.Shared.IChildEntityCollection<global::Sungero.Domain.Shared.IChildEntity> entityCollection)
            {
              var args = new global::Sungero.Domain.Client.WpfCanExecuteChildCollectionActionArgs(this.Entity, this);
              return global::Sungero.Domain.Client.ActionExecutor.CanExecuteChildEntityAction<global::Sungero.Domain.Client.WpfCanExecuteChildCollectionActionArgs>(selectedEntity, entityCollection, args,
                ((Sungero.Parties.Client.CounterpartyExchangeBoxesActions)(this.Entity as global::Sungero.Parties.Client.Counterparty).ExchangeBoxesActionsHandlers).CanShowDepartmentBoxes);
            }

            private void ShowDepartmentBoxes(global::Sungero.Domain.Shared.IChildEntity selectedEntity,
              global::Sungero.Domain.Shared.IChildEntityCollection<global::Sungero.Domain.Shared.IChildEntity> entityCollection)
            {
              var args = new global::Sungero.Domain.Client.WpfExecuteChildCollectionActionArgs(this.Entity, this);
              global::Sungero.Domain.Client.ActionExecutor.ExecuteChildEntityAction<global::Sungero.Domain.Client.WpfExecuteChildCollectionActionArgs>(selectedEntity, entityCollection, args,
                ((Sungero.Parties.Client.CounterpartyExchangeBoxesActions)(this.Entity as global::Sungero.Parties.Client.Counterparty).ExchangeBoxesActionsHandlers).ShowDepartmentBoxes);
            }
            private bool CanEditExchange(global::Sungero.Domain.Shared.IChildEntity selectedEntity,
              global::Sungero.Domain.Shared.IChildEntityCollection<global::Sungero.Domain.Shared.IChildEntity> entityCollection)
            {
              var args = new global::Sungero.Domain.Client.WpfCanExecuteChildCollectionActionArgs(this.Entity, this);
              return global::Sungero.Domain.Client.ActionExecutor.CanExecuteChildEntityAction<global::Sungero.Domain.Client.WpfCanExecuteChildCollectionActionArgs>(selectedEntity, entityCollection, args,
                ((Sungero.Parties.Client.CounterpartyExchangeBoxesActions)(this.Entity as global::Sungero.Parties.Client.Counterparty).ExchangeBoxesActionsHandlers).CanEditExchange);
            }

            private void EditExchange(global::Sungero.Domain.Shared.IChildEntity selectedEntity,
              global::Sungero.Domain.Shared.IChildEntityCollection<global::Sungero.Domain.Shared.IChildEntity> entityCollection)
            {
              var args = new global::Sungero.Domain.Client.WpfExecuteChildCollectionActionArgs(this.Entity, this);
              global::Sungero.Domain.Client.ActionExecutor.ExecuteChildEntityAction<global::Sungero.Domain.Client.WpfExecuteChildCollectionActionArgs>(selectedEntity, entityCollection, args,
                ((Sungero.Parties.Client.CounterpartyExchangeBoxesActions)(this.Entity as global::Sungero.Parties.Client.Counterparty).ExchangeBoxesActionsHandlers).EditExchange);
            }
    ...
    protected override void EntityPropertyChangedEventHandler(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
    {
      base.EntityPropertyChangedEventHandler(sender, e);
          ...
          get { return this._ResponsibleCollectionPresenter; }
              ...
              protected global::Sungero.Domain.Client.IEntityCollectionPresenter _KindCollectionPresenter;
              public global::Sungero.Domain.Client.IEntityCollectionPresenter KindCollectionPresenter
              {
          get { return this._KindCollectionPresenter; }
        }
    ...
    private void Init()
    {
              ...
              .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.Company.IEmployee>(() => this.Entity.Id, typeof(T), "Responsible");
                  ...
                  this._KindCollectionPresenter = this.CreateCollectionPresenterForNavigationProperty<global::Sungero.Parties.ICounterpartyKind>(global::System.Guid.Parse("2c4e6df8-326c-4e27-8515-238c3f6f835f"));
