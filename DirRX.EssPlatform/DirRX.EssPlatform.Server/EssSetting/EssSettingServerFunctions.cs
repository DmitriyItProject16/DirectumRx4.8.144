  ...
  partial class EssSettingFunctions
  {
    ...
    public DirRX.EssPlatform.Structures.Module.LoginResult LoginIds(string password, bool passwordIsEncrypted)
    {
      ...
      try
      {
        ...
        token = DirRX.EssPlatform.PublicFunctions.Module.Remote.GetAnAuthenticationToken(_obj.IdentityServiceLogin, password, PublicFunctions.EssSetting.GetSettings().IdentityServiceLogin, _obj.IdentityServiceAddress);
      }
      catch (Exception e)
      {
    ...
    public static void CreateSettings()
    {
      ...
      essSettings.ConfirmationType = EssPlatform.EssSetting.ConfirmationType.DefaultValue;
      essSettings.Save();
    }
