...
namespace Sungero.Contracts.Client
{
    ...
    global::Sungero.Docflow.Client.ContractualDocumentBase, global::Sungero.Contracts.IContractualDocument
  {
    ...
    protected override global::Sungero.Domain.Shared.IEntityAccessRights CreateAccessRights()
    {
      return new global::Sungero.Contracts.Client.ContractualDocumentAccessRights(this);
        ...
        protected global::Sungero.Domain.Client.SimpleProperty<global::System.String> _CounterpartyRegistrationNumber;

        public virtual global::System.String CounterpartyRegistrationNumber
        {
          get { return this._CounterpartyRegistrationNumber.Value; }
          set { this._CounterpartyRegistrationNumber.Value = value; }
        }
  ...
  protected global::System.String CounterpartyRegistrationNumberValueInputHandler(global::System.String value)
  {
    var args = new global::Sungero.Presentation.StringValueInputEventArgs(this.CounterpartyRegistrationNumber, value, this, this.Info.Properties.CounterpartyRegistrationNumber);
    ((global::Sungero.Contracts.ContractualDocumentClientHandlers)this.Handlers).CounterpartyRegistrationNumberValueInput(args);
    return args.NewValue;
  }
    ...
    public ContractualDocument()
    {
            ...
            this._CounterpartyRegistrationNumber = new global::Sungero.Domain.Client.SimpleProperty<global::System.String>("CounterpartyRegistrationNumber", this);
            this._CounterpartyRegistrationNumber.ValueChanged += (sender, e) => { this.CounterpartyRegistrationNumberChangedHandler(); };
            this.AddProperty(this._CounterpartyRegistrationNumber);
...
namespace Sungero.Contracts.Client
{
    ...
    where T : class, global::Sungero.Contracts.IContractualDocument
  {
    #region Fields and properties
          ...
          private global::System.Windows.Input.ICommand _CreateIncomingInvoiceCommand;

          public global::System.Windows.Input.ICommand CreateIncomingInvoiceCommand
          {
            get
            {
              if (this._CreateIncomingInvoiceCommand == null)
                  this._CreateIncomingInvoiceCommand = new global::Sungero.Domain.Client.SingleEntityCommand<T>("CreateIncomingInvoice", this, this.CreateIncomingInvoice, this.CanCreateIncomingInvoice) { IsEmptyParameterAllowed = true };
              return this._CreateIncomingInvoiceCommand;
            }
          }
          private global::System.Windows.Input.ICommand _CreateOutgoingInvoiceCommand;

          public global::System.Windows.Input.ICommand CreateOutgoingInvoiceCommand
          {
            get
            {
              if (this._CreateOutgoingInvoiceCommand == null)
                  this._CreateOutgoingInvoiceCommand = new global::Sungero.Domain.Client.SingleEntityCommand<T>("CreateOutgoingInvoice", this, this.CreateOutgoingInvoice, this.CanCreateOutgoingInvoice) { IsEmptyParameterAllowed = true };
              return this._CreateOutgoingInvoiceCommand;
            }
          }
    ...
    #region Methods
              ...
              private bool CanCreateIncomingInvoice(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfCanExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this);
                return ((Sungero.Contracts.Client.ContractualDocumentActions)(entity as Sungero.Contracts.Client.ContractualDocument).ActionsHandlers).CanCreateIncomingInvoice(args);
              }

              private void CreateIncomingInvoice(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this, entity.Info.Actions.CreateIncomingInvoice);
                ((Sungero.Contracts.Client.ContractualDocumentActions)(entity as Sungero.Contracts.Client.ContractualDocument).ActionsHandlers).CreateIncomingInvoice(args);
              }
              private bool CanCreateOutgoingInvoice(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfCanExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this);
                return ((Sungero.Contracts.Client.ContractualDocumentActions)(entity as Sungero.Contracts.Client.ContractualDocument).ActionsHandlers).CanCreateOutgoingInvoice(args);
              }

              private void CreateOutgoingInvoice(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this, entity.Info.Actions.CreateOutgoingInvoice);
                ((Sungero.Contracts.Client.ContractualDocumentActions)(entity as Sungero.Contracts.Client.ContractualDocument).ActionsHandlers).CreateOutgoingInvoice(args);
              }
...
namespace Sungero.Contracts.Client
{
    ...
    where T: class, global::Sungero.Contracts.IContractualDocument
  {
    ...
    #region Methods
        ...
        private void CreateIncomingInvoice(T entity)
        {
          var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Collection, entity, this, entity.Info.Actions.CreateIncomingInvoice);
          ((Sungero.Contracts.Client.ContractualDocumentActions)(entity as Sungero.Contracts.Client.ContractualDocument).ActionsHandlers).CreateIncomingInvoice(args);
        }
        ...
        private void CreateOutgoingInvoice(T entity)
        {
          var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Collection, entity, this, entity.Info.Actions.CreateOutgoingInvoice);
          ((Sungero.Contracts.Client.ContractualDocumentActions)(entity as Sungero.Contracts.Client.ContractualDocument).ActionsHandlers).CreateOutgoingInvoice(args);
        }
