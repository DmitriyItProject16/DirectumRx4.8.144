...
namespace Sungero.ExchangeCore.Server
{
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.IBodyConverterQueueItem
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.BodyConverterQueueItemDocumentPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.ExchangeCore.BodyConverterQueueItemDocumentPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).DocumentFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.Docflow.IOfficialDocument
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.BodyConverterQueueItemDocumentSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.ExchangeCore.BodyConverterQueueItemDocumentSearchPropertyFilteringServerHandler<TQueryEntity>().DocumentSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.ExchangeCore.Server.QueueItemBase, global::Sungero.ExchangeCore.IBodyConverterQueueItem
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.ExchangeCore.BodyConverterQueueItemCreatingFromServerHandler", new object[] { (global::Sungero.ExchangeCore.IBodyConverterQueueItem)entitySource, this.Info });
      if (instance != null)
    ...
    protected void DocumentChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IBodyConverterQueueItemSharedHandlers)this.SharedHandlers).DocumentChanged(args);
    }
    ...
    protected void VersionIdChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IBodyConverterQueueItemSharedHandlers)this.SharedHandlers).VersionIdChanged(args);
    }
    ...
    protected void ExchangeStateChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IBodyConverterQueueItemSharedHandlers)this.SharedHandlers).ExchangeStateChanged(args);
    }
...
namespace Sungero.ExchangeCore.Functions
{
  ...
  {
    /// <redirect project="Sungero.ExchangeCore.Server" type="Sungero.ExchangeCore.Server.BodyConverterQueueItemFunctions" />
    internal static  global::System.Boolean HasSimilarQueueItemInProcessing(global::Sungero.ExchangeCore.IBodyConverterQueueItem bodyConverterQueueItem)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)bodyConverterQueueItem).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("HasSimilarQueueItemInProcessing", new System.Type[] {  });
    ...
    /// <redirect project="Sungero.ExchangeCore.Server" type="Sungero.ExchangeCore.Server.BodyConverterQueueItemFunctions" />
    internal static  global::System.Boolean IsObsoleteQueueItem(global::Sungero.ExchangeCore.IBodyConverterQueueItem bodyConverterQueueItem)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)bodyConverterQueueItem).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("IsObsoleteQueueItem", new System.Type[] {  });
      return (global::System.Boolean)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] {  });
    }
...
namespace Sungero.ExchangeCore.Server
{
  ...
  {
    public global::System.Boolean HasSimilarQueueItemInProcessing(global::Sungero.ExchangeCore.IBodyConverterQueueItem bodyConverterQueueItem)
    {
      return global::Sungero.ExchangeCore.Functions.BodyConverterQueueItem.HasSimilarQueueItemInProcessing(bodyConverterQueueItem);
    }
    public global::System.Boolean IsObsoleteQueueItem(global::Sungero.ExchangeCore.IBodyConverterQueueItem bodyConverterQueueItem)
    {
      return global::Sungero.ExchangeCore.Functions.BodyConverterQueueItem.IsObsoleteQueueItem(bodyConverterQueueItem);
    }
  }
}
