...
{
  public class EnvelopeC5Report : global::Sungero.Reporting.Server.Report, global::Sungero.Docflow.IEnvelopeC5Report
  {
    ...
    protected override void FillDataSources(global::FastReport.Report report)
    {
      ...
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.EnvelopeC5ReportServerHandlers");
      if (type != null)
      {
      }
      else
    ...
    public EnvelopeC5Report()
    {
      ...
      this.Handlers = type != null
        ...
        : new global::Sungero.Docflow.EnvelopeC5ReportServerHandlers(this);
    }
  }
}
...
{
  public partial class EnvelopeC5ReportServerHandlers : global::Sungero.Reporting.ReportServerHandlers
  {
    ...
    public EnvelopeC5ReportServerHandlers(global::Sungero.Docflow.IEnvelopeC5Report report) : base(report) { }
  }
}
...
{
  public class EnvelopeC5Report
  {
    private static global::Sungero.Domain.SqlQueryResolver resolver = new global::Sungero.Domain.SqlQueryResolver("Sungero.Docflow.Server.Reports.EnvelopeC5Report.EnvelopeC5ReportQueries.xml", System.Reflection.Assembly.GetExecutingAssembly());
