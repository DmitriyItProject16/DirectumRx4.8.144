...
namespace Sungero.Docflow.Server
{
    ...
    where TSourceEntity : class, global::Sungero.Docflow.ICheckReturnTask
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.CheckReturnTaskAssigneePropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.Docflow.CheckReturnTaskAssigneePropertyFilteringServerHandler<TQueryEntity>(sourceEntity).AssigneeFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.CheckReturnTaskAssigneeSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.Docflow.CheckReturnTaskAssigneeSearchPropertyFilteringServerHandler<TQueryEntity>().AssigneeSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.Docflow.ICheckReturnTask
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.CheckReturnTaskDocumentToReturnPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
        var methodInfo = genericType.GetMethod("DocumentToReturnFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.Docflow.CheckReturnTaskDocumentToReturnPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).DocumentToReturnFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.Content.IElectronicDocument
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.CheckReturnTaskDocumentToReturnSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("DocumentToReturnSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.Docflow.CheckReturnTaskDocumentToReturnSearchPropertyFilteringServerHandler<TQueryEntity>().DocumentToReturnSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Workflow.Server.Task, global::Sungero.Docflow.ICheckReturnTask, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Docflow.CheckReturnTaskCreatingFromServerHandler", new object[] { (global::Sungero.Docflow.ICheckReturnTask)entitySource, this.Info });
      if (instance != null)
    ...
    protected void AssigneeChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).AssigneeChanged(args);
    }
    ...
    protected void DeadlineChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).DeadlineChanged(args);
    }
    ...
    protected void AssignmentStartDateChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).AssignmentStartDateChanged(args);
    }
    ...
    protected void DocumentToReturnChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).DocumentToReturnChanged(args);
    }
    ...
    private void AttachmentCreatedHandler(object sender, global::Sungero.Workflow.Interfaces.AttachmentCreatedEventArgs e)
    {
      ...
      {
        ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).DocumentGroupCreated(e);
        return;
      }
    ...
    private void AttachmentAddedHandler(object sender, global::Sungero.Workflow.Interfaces.AttachmentAddedEventArgs e)
    {
      if (((global::Sungero.Workflow.Interfaces.IInternalAttachmentEventArgs)e).GroupName == "DocumentGroup")
      {
        ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).DocumentGroupAdded(e);
        return;
      }
    ...
    private void AttachmentDeletedHandler(object sender, global::Sungero.Workflow.Interfaces.AttachmentDeletedEventArgs e)
    {
      if (((global::Sungero.Workflow.Interfaces.IInternalAttachmentEventArgs)e).GroupName == "DocumentGroup")
      {
        ((global::Sungero.Docflow.ICheckReturnTaskSharedHandlers)this.SharedHandlers).DocumentGroupDeleted(e);
        return;
      }
    ...
    public new virtual global::Sungero.Docflow.ICheckReturnTaskBlocksInfo Blocks
    {
      get
      {
        return new global::Sungero.Docflow.Server.CheckReturnTaskBlocksInfo(this);
      }
    }
...
namespace Sungero.Docflow.Functions
{
  internal static class CheckReturnTask
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.Server.CheckReturnTaskFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetAssignmentBlock",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Workflow.IAssignmentBase) }, null);
        return (Sungero.Core.StateBlock)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { assignment });
      }
      else
      {
    ...
    /// <redirect project="Sungero.Docflow.Server" type="Sungero.Docflow.Server.CheckReturnTaskFunctions" />
    internal static  void SetReturnResult(global::Sungero.Docflow.ICheckReturnTask returnControl, global::Sungero.CoreEntities.IUser performer, global::System.Boolean documentIsReturned)
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.Server.CheckReturnTaskFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("SetReturnResult",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Docflow.ICheckReturnTask), typeof(global::Sungero.CoreEntities.IUser), typeof(global::System.Boolean) }, null);
    global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { returnControl, performer, documentIsReturned });
      }
      else
      {
    global::Sungero.Docflow.Server.CheckReturnTaskFunctions.SetReturnResult(returnControl, performer, documentIsReturned);
      }
    }
    /// <redirect project="Sungero.Docflow.Server" type="Sungero.Docflow.Server.CheckReturnTaskFunctions" />
    internal static  global::Sungero.Docflow.IOfficialDocumentTracking GetTrackingByTask(global::Sungero.Docflow.ICheckReturnTask returnControl)
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.Server.CheckReturnTaskFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetTrackingByTask",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Docflow.ICheckReturnTask) }, null);
        return (global::Sungero.Docflow.IOfficialDocumentTracking)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { returnControl });
      }
      else
      {
        return global::Sungero.Docflow.Server.CheckReturnTaskFunctions.GetTrackingByTask(returnControl);
      }
    }
...
// ==================================================================
// CheckReturnTaskBlockHandlers.g.cs
// ==================================================================
...
// ==================================================================
// CheckReturnTaskBlocksInfo.g.cs
// ==================================================================
...
namespace Sungero.Docflow.Server
{
  public class CheckReturnTaskBlocksInfo : global::Sungero.Docflow.ICheckReturnTaskBlocksInfo
  {
    private readonly Sungero.Workflow.ITask task;

      public global::Sungero.Workflow.ITaskMonitoringBlockInfo Block2
      {
        get
        {
          return new global::Sungero.Workflow.Server.TaskMonitoringBlockInfo(this.task, "2");
        }
      }
    ...
    public CheckReturnTaskBlocksInfo(Sungero.Workflow.ITask task)
    {
      this.task = task;
    }
  }
