...
namespace Sungero.Contracts.Server
{
    ...
    where TSourceEntity : class, global::Sungero.Contracts.ISupAgreement
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.SupAgreementLeadingDocumentPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.Contracts.SupAgreementLeadingDocumentPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).LeadingDocumentFiltering(query, args);
      }
    ...
    global::Sungero.Contracts.Server.ContractualDocument, global::Sungero.Contracts.ISupAgreement, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Contracts.SupAgreementCreatingFromServerHandler", new object[] { (global::Sungero.Contracts.ISupAgreement)entitySource, this.Info });
      if (instance != null)
    ...
    protected override global::Sungero.Domain.Shared.EntityConvertingFromServerHandler CreateConvertingFromServerHandler(   
      global::Sungero.Domain.Shared.IEntity entitySource)
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Contracts.SupAgreementConvertingFromServerHandler", (global::Sungero.Content.IElectronicDocument)entitySource, this.Info);
      if (instance != null)
...
namespace Sungero.Contracts.Functions
{
  internal static class SupAgreement
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.Server.SupAgreementFunctions");
      if (__funcType != null)
      {    
        ...
        return (global::System.Linq.IQueryable<global::Sungero.Contracts.ISupAgreement>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { supAgreement, businessUnit, registrationNumber, registrationDate, counterparty, contract });
      }
      else
      {
    ...
    internal static  global::System.String GetNamePartBySupAgreementIgnoreAccessRights(global::System.Int64 supAgreementId)
    {
      ...
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetNamePartBySupAgreementIgnoreAccessRights",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::System.Int64) }, null);
        return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { supAgreementId });
      }
      else
      {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)supAgreement).FunctionsContainer.ServerFunctions;
    ...
    /// <redirect project="Sungero.Contracts.Server" type="Sungero.Contracts.Server.SupAgreementFunctions" />
    internal static  void SetLifeCycleStateDraft(global::Sungero.Contracts.ISupAgreement supAgreement)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)supAgreement).FunctionsContainer.ServerFunctions;
