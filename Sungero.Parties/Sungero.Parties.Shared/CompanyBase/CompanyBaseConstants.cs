namespace Sungero.Parties.Constants
{
  public static class CompanyBase
  {
    ...
    public const string ElasticsearchIndexConfig = @"{{
      ""settings"": {{
        ""index"": {{
          ""similarity"": {{""default"": {{""type"": ""BM25"", ""b"": 0, ""k1"": 0}}}},
          ""analysis"": {{
            ""filter"": {{
              ""my_synonyms"": {{
                ""type"": ""synonym_graph"",
            ...
            ""char_filter"": {{""e_char_filter"": {{""type"": ""mapping"", ""mappings"": [""Ё => Е"", ""ё => е""]}}}},
            ""analyzer"": {{
              ""name_index_analyzer"": {{""tokenizer"": ""standard"", ""filter"": [""lowercase""], ""char_filter"": [""e_char_filter""]}},
              ""name_query_analyzer"": {{""tokenizer"": ""standard"", ""filter"": [""lowercase"", ""my_synonyms""], ""char_filter"": [""e_char_filter""]}},
              ""email_analyzer"": {{""tokenizer"": ""uax_url_email"", ""filter"" : [""lowercase""]}}
            }}
          }}
        }}
      }},
      ""mappings"": {{
        ""properties"": {{
          ""Id"": {{""type"": ""keyword""}},
          ""Name"": {{""type"": ""text"", ""analyzer"": ""name_index_analyzer"", ""search_analyzer"": ""name_query_analyzer""}},
          ""ShortName"": {{""type"": ""text"", ""analyzer"": ""name_index_analyzer""}},
          ""HeadCompany"": {{""type"": ""text"", ""analyzer"": ""name_index_analyzer""}},
          ""TIN"": {{""type"": ""keyword""}},
          ""TRRC"": {{""type"": ""keyword""}},
          ""PSRN"": {{""type"": ""keyword""}},
          ""Address"": {{""type"": ""text"", ""analyzer"": ""name_index_analyzer""}},
          ""Homepage"": {{""type"": ""text"", ""analyzer"": ""name_index_analyzer""}},
    ...
    /// </summary>
    [Sungero.Core.Public]
    public const double ElasticsearchMinScore = 1;
  }
}