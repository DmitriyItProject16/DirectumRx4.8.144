...
namespace Sungero.Docflow.Server
{
  partial class ApprovalRuleFunctions
  {
                                               ...
                                               Structures.ApprovalRuleBase.RouteStep conditionStep)
    {
      ...
      {
        var addresseeConditions = this.GetConditionsInRoute(route, Docflow.Condition.ConditionType.Addressee).Where(x => x.StepNumber != conditionStep.StepNumber).ToList();
      ...
      {
        var manyAddresseesConditions = this.GetConditionsInRoute(route, Docflow.Condition.ConditionType.ManyAddressees).Where(x => x.StepNumber != conditionStep.StepNumber).ToList();
