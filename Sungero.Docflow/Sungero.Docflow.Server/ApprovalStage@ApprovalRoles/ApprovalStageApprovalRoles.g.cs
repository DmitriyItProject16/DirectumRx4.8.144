...
namespace Sungero.Docflow.Server
{
    ...
    where TRootEntity : class, global::Sungero.Docflow.IApprovalStage
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.ApprovalStageApprovalRolesApprovalRolePropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("ApprovalRolesApprovalRoleFiltering");
      ...
      {
        result = new global::Sungero.Docflow.ApprovalStageApprovalRolesApprovalRolePropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).ApprovalRolesApprovalRoleFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.Docflow.IApprovalRoleBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.ApprovalStageApprovalRolesApprovalRoleSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("ApprovalRolesApprovalRoleSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.Docflow.ApprovalStageApprovalRolesApprovalRoleSearchPropertyFilteringServerHandler<TQueryEntity>().ApprovalRolesApprovalRoleSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.Docflow.IApprovalStageApprovalRoles
  {
    ...
    protected void ApprovalRoleChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IApprovalStageApprovalRolesSharedHandlers)this.SharedHandlers).ApprovalRolesApprovalRoleChanged(args);
    }
