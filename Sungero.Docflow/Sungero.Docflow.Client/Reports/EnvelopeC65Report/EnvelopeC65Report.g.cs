...
{
  public class EnvelopeC65Report : global::Sungero.Reporting.Client.Report, global::Sungero.Docflow.IEnvelopeC65Report
  {
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.EnvelopeC65ReportClientHandlers");
      this.Handlers = type != null
        ? global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this })
        : new global::Sungero.Docflow.EnvelopeC65ReportClientHandlers(this);
    }
  }
}
