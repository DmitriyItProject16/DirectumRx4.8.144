...
namespace Sungero.Contracts.Server
{
    ...
    global::Sungero.Docflow.Server.ApprovalRoleBase, global::Sungero.Contracts.IContractApprovalRole
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Contracts.ContractApprovalRoleCreatingFromServerHandler", new object[] { (global::Sungero.Contracts.IContractApprovalRole)entitySource, this.Info });
      if (instance != null)
...
namespace Sungero.Contracts.Functions
{
  internal static class ContractApprovalRole
  {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)contractApprovalRole).FunctionsContainer.ServerFunctions;
