...
namespace Sungero.Docflow.Client
{
    ...
    global::Sungero.Domain.Client.ChildEntityProxy, global::Sungero.Docflow.IOutgoingDocumentBaseAddressees
  {
    ...
    public override global::Sungero.Domain.Shared.IEntity RootEntity
    {
      ...
      set { this.OutgoingDocumentBase = (global::Sungero.Docflow.IOutgoingDocumentBase)value; }
        ...
        protected global::Sungero.Domain.Client.SimpleProperty<global::System.DateTime?> _SentDate;

        public virtual global::System.DateTime? SentDate
        {
          get { return this._SentDate.Value; }
          set { this._SentDate.Value = value; }
        }
        protected global::Sungero.Domain.Client.SimpleProperty<global::System.String> _TrackNumber;

        public virtual global::System.String TrackNumber
        {
          get { return this._TrackNumber.Value; }
          set { this._TrackNumber.Value = value; }
        }
  ...
  protected global::System.DateTime? SentDateValueInputHandler(global::System.DateTime? value)
  {
    var args = new global::Sungero.Presentation.DateTimeValueInputEventArgs(this.SentDate, value, this, this.Info.Properties.SentDate);
    ((global::Sungero.Docflow.OutgoingDocumentBaseAddresseesClientHandlers)this.Handlers).AddresseesSentDateValueInput(args);
    return args.NewValue;
  }

  protected global::System.String TrackNumberValueInputHandler(global::System.String value)
  {
    var args = new global::Sungero.Presentation.StringValueInputEventArgs(this.TrackNumber, value, this, this.Info.Properties.TrackNumber);
    ((global::Sungero.Docflow.OutgoingDocumentBaseAddresseesClientHandlers)this.Handlers).AddresseesTrackNumberValueInput(args);
    return args.NewValue;
  }
    ...
    public OutgoingDocumentBaseAddressees()
    {
      this._OutgoingDocumentBase = new global::Sungero.Domain.Client.NavigationProperty<global::Sungero.Docflow.IOutgoingDocumentBase>("OutgoingDocumentBase", this, true);
            ...
            this._SentDate = new global::Sungero.Domain.Client.SimpleProperty<global::System.DateTime?>("SentDate", this);
            this._SentDate.ValueChanged += (sender, e) => { this.SentDateChangedHandler(); };
            this.AddProperty(this._SentDate);

            this._TrackNumber = new global::Sungero.Domain.Client.SimpleProperty<global::System.String>("TrackNumber", this);
            this._TrackNumber.ValueChanged += (sender, e) => { this.TrackNumberChangedHandler(); };
            this.AddProperty(this._TrackNumber);
