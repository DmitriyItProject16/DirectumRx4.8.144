...
namespace Sungero.Docflow.Server
{
    ...
    where TRootEntity : class, global::Sungero.Docflow.IAccessRightsRule
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.AccessRightsRuleMembersRecipientPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("MembersRecipientFiltering");
      ...
      {
        result = new global::Sungero.Docflow.AccessRightsRuleMembersRecipientPropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).MembersRecipientFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.AccessRightsRuleMembersRecipientSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("MembersRecipientSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.Docflow.AccessRightsRuleMembersRecipientSearchPropertyFilteringServerHandler<TQueryEntity>().MembersRecipientSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.Docflow.IAccessRightsRuleMembers
  {
    ...
    protected void RecipientChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IAccessRightsRuleMembersSharedHandlers)this.SharedHandlers).MembersRecipientChanged(args);
    }
    ...
    protected void RightTypeChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IAccessRightsRuleMembersSharedHandlers)this.SharedHandlers).MembersRightTypeChanged(args);
    }
