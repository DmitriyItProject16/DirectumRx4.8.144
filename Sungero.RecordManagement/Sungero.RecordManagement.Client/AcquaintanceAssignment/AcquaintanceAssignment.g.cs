...
namespace Sungero.RecordManagement.Client
{
    ...
    where T : class, global::Sungero.RecordManagement.IAcquaintanceAssignment
  {
    #region Fields and properties
          ...
          private global::System.Windows.Input.ICommand _OpenDocumentCommand;

          public global::System.Windows.Input.ICommand OpenDocumentCommand
          {
            get
            {
              if (this._OpenDocumentCommand == null)
                  this._OpenDocumentCommand = new global::Sungero.Domain.Client.SingleEntityCommand<T>("OpenDocument", this, this.OpenDocument, this.CanOpenDocument) { IsEmptyParameterAllowed = true };
              return this._OpenDocumentCommand;
            }
          }
    ...
    #region Methods
              ...
              private bool CanOpenDocument(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfCanExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this);
                return ((Sungero.RecordManagement.Client.AcquaintanceAssignmentActions)(entity as Sungero.RecordManagement.Client.AcquaintanceAssignment).ActionsHandlers).CanOpenDocument(args);
              }

              private void OpenDocument(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this, entity.Info.Actions.OpenDocument);
                ((Sungero.RecordManagement.Client.AcquaintanceAssignmentActions)(entity as Sungero.RecordManagement.Client.AcquaintanceAssignment).ActionsHandlers).OpenDocument(args);
              }
...
// ==================================================================
// AcquaintanceAssignmentBlocksInfo.g.cs
// ==================================================================
