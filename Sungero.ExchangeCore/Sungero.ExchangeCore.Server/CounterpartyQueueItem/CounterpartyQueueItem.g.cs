...
namespace Sungero.ExchangeCore.Server
{
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.ICounterpartyQueueItem
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.CounterpartyQueueItemMatchingTaskPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("MatchingTaskFiltering");
      ...
      {
        result = new global::Sungero.ExchangeCore.CounterpartyQueueItemMatchingTaskPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).MatchingTaskFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.Workflow.ITask
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.CounterpartyQueueItemMatchingTaskSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("MatchingTaskSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.ExchangeCore.CounterpartyQueueItemMatchingTaskSearchPropertyFilteringServerHandler<TQueryEntity>().MatchingTaskSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.ICounterpartyQueueItem
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.CounterpartyQueueItemCounterpartyPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.ExchangeCore.CounterpartyQueueItemCounterpartyPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).CounterpartyFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.Parties.ICounterparty
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.CounterpartyQueueItemCounterpartySearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
      ...
      {
        result = new global::Sungero.ExchangeCore.CounterpartyQueueItemCounterpartySearchPropertyFilteringServerHandler<TQueryEntity>().CounterpartySearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.ExchangeCore.Server.QueueItemBase, global::Sungero.ExchangeCore.ICounterpartyQueueItem
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.ExchangeCore.CounterpartyQueueItemCreatingFromServerHandler", new object[] { (global::Sungero.ExchangeCore.ICounterpartyQueueItem)entitySource, this.Info });
      if (instance != null)
    ...
    protected void MatchingTaskChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.ICounterpartyQueueItemSharedHandlers)this.SharedHandlers).MatchingTaskChanged(args);
    }
    ...
    protected void SyncResultChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.ICounterpartyQueueItemSharedHandlers)this.SharedHandlers).SyncResultChanged(args);
    }
    ...
    protected void CounterpartyChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.ICounterpartyQueueItemSharedHandlers)this.SharedHandlers).CounterpartyChanged(args);
    }
    ...
    protected void CounterpartyBranchIdChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.ICounterpartyQueueItemSharedHandlers)this.SharedHandlers).CounterpartyBranchIdChanged(args);
    }
