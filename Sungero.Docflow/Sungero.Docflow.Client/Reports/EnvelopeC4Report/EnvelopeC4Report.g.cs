...
{
  public class EnvelopeC4Report : global::Sungero.Reporting.Client.Report, global::Sungero.Docflow.IEnvelopeC4Report
  {
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.EnvelopeC4ReportClientHandlers");
      this.Handlers = type != null
        ? global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this })
        : new global::Sungero.Docflow.EnvelopeC4ReportClientHandlers(this);
    }
  }
}
