...
namespace DirRX.EssPlatform.Shared
{
  partial class EssSettingFunctions
  {
    ...
    public virtual void SwitchPropertiesAvailability()
    {
      ...
      _obj.State.Properties.EssServiceAddress.IsEnabled = isEnabled;
      _obj.State.Properties.AgreementUrl.IsEnabled = isEnabled;
      _obj.State.Properties.EssServiceAddress.IsEnabled = isEnabled;
      _obj.State.Properties.DaysToWarnCert.IsEnabled = isEnabled;
      _obj.State.Properties.SignServiceAddress.IsEnabled = isEnabled;
      _obj.State.Properties.CertificateMail.IsEnabled = isEnabled;
      _obj.State.Properties.ConfirmationType.IsEnabled = isEnabled;
      ...
      _obj.State.Properties.EssServiceAddress.IsRequired = isEnabled;
      _obj.State.Properties.AgreementUrl.IsRequired = isEnabled;
      _obj.State.Properties.EssServiceAddress.IsRequired = isEnabled;
      _obj.State.Properties.DaysToWarnCert.IsRequired = isEnabled;
      _obj.State.Properties.SignServiceAddress.IsRequired = isEnabled;
      _obj.State.Properties.CertificateMail.IsRequired = isEnabled;
      _obj.State.Properties.ConfirmationType.IsRequired = isEnabled;
    }
  }
}