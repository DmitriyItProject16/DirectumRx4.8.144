...
namespace Sungero.Parties.Server
{
    ...
    global::Sungero.Parties.Server.CompanyBase, global::Sungero.Parties.ICompany
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Parties.CompanyCreatingFromServerHandler", new object[] { (global::Sungero.Parties.ICompany)entitySource, this.Info });
      if (instance != null)
