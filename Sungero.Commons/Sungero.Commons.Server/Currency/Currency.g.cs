...
namespace Sungero.Commons.Server
{
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.Commons.ICurrency
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Commons.CurrencyCreatingFromServerHandler", new object[] { (global::Sungero.Commons.ICurrency)entitySource, this.Info });
      if (instance != null)
    ...
    protected void NameChangedHandler()
    {
     ...
     ((global::Sungero.Commons.ICurrencySharedHandlers)this.SharedHandlers).NameChanged(args);
    }
    ...
    protected void AlphaCodeChangedHandler()
    {
     ...
     ((global::Sungero.Commons.ICurrencySharedHandlers)this.SharedHandlers).AlphaCodeChanged(args);
    }
    ...
    protected void ShortNameChangedHandler()
    {
     ...
     ((global::Sungero.Commons.ICurrencySharedHandlers)this.SharedHandlers).ShortNameChanged(args);
    }
    ...
    protected void FractionNameChangedHandler()
    {
     ...
     ((global::Sungero.Commons.ICurrencySharedHandlers)this.SharedHandlers).FractionNameChanged(args);
    }
    ...
    protected void IsDefaultChangedHandler()
    {
     ...
     ((global::Sungero.Commons.ICurrencySharedHandlers)this.SharedHandlers).IsDefaultChanged(args);
    }
    ...
    protected void NumericCodeChangedHandler()
    {
     ...
     ((global::Sungero.Commons.ICurrencySharedHandlers)this.SharedHandlers).NumericCodeChanged(args);
    }
...
namespace Sungero.Commons.Functions
{
  internal static class Currency
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Commons.Server.CurrencyFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetDefaultCurrency",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] {  }, null);
        return (global::Sungero.Commons.ICurrency)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] {  });
      }
      else
      {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)currency).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("GetDuplicates", new System.Type[] {  });
      return (global::System.Linq.IQueryable<global::Sungero.Commons.ICurrency>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] {  });
    }
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)currency).FunctionsContainer.SharedFunctions;
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Commons.Shared.CurrencyFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("ValidateNumericCode",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::System.String) }, null);
        return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { numericCode });
      }
      else
      {
