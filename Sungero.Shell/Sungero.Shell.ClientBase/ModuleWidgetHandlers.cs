...
namespace Sungero.Shell.Client
{
  ...
  partial class AssignmentCompletionEmployeeGraphWidgetHandlers
  {
    ...
    public virtual void ExecuteAssignmentCompletionEmployeeGraphOpenReportAction()
    {
      ...
      Docflow.PublicFunctions.Module.OpenEmployeesAssignmentCompletionReport(null, null, new List<long>(), departmentIds, periodBegin, Calendar.UserToday, widgetParameter, unwrap, false, true);
    }
    ...
    {
      long employeeId;
      if (!long.TryParse(e.ValueId, out employeeId))
      {
  ...
  partial class TopLoadedDepartmentsGraphWidgetHandlers
  {
    ...
    public virtual void ExecuteTopLoadedDepartmentsGraphTopLoadedDepartmentsAction(Sungero.Domain.Client.ExecuteWidgetBarChartActionEventArgs e)
    {
      ...
      PublicFunctions.Module.OpenReportFromDepartmentWidgets(departmentId, new List<long>() { departmentId },  _parameters.Performer, _parameters.Period, false);
    }
  }
  ...
  partial class TopLoadedPerformersGraphWidgetHandlers
  {
    ...
    public virtual void ExecuteTopLoadedPerformersGraphOpenReportAction()
    {
      ...
      Docflow.PublicFunctions.Module.OpenEmployeesAssignmentCompletionReport(null, null, new List<long>(), departmentIds, periodBegin, Calendar.UserToday, widgetParameter, unwrap, false, false);
    }
    ...
    {
      long employeeId;
      if (!long.TryParse(e.SeriesId, out employeeId))
      {
