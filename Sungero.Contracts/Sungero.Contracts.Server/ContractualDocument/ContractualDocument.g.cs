...
namespace Sungero.Contracts.Server
{
    ...
    where TSourceEntity : class, global::Sungero.Contracts.IContractualDocument
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.ContractualDocumentCounterpartySignatoryPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.Contracts.ContractualDocumentCounterpartySignatoryPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).CounterpartySignatoryFiltering(query, args);
      }
    ...
    where TSourceEntity : class, global::Sungero.Contracts.IContractualDocument
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.ContractualDocumentContactPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.Contracts.ContractualDocumentContactPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).ContactFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.Parties.IContact
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.ContractualDocumentContactSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.Contracts.ContractualDocumentContactSearchPropertyFilteringServerHandler<TQueryEntity>().ContactSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.Contracts.IContractualDocument
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.ContractualDocumentResponsibleEmployeePropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.Contracts.ContractualDocumentResponsibleEmployeePropertyFilteringServerHandler<TQueryEntity>(sourceEntity).ResponsibleEmployeeFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.ContractualDocumentResponsibleEmployeeSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
      ...
      {
        result = new global::Sungero.Contracts.ContractualDocumentResponsibleEmployeeSearchPropertyFilteringServerHandler<TQueryEntity>().ResponsibleEmployeeSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Docflow.Server.ContractualDocumentBase, global::Sungero.Contracts.IContractualDocument, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    private global::System.String _CounterpartyRegistrationNumber;
    public virtual global::System.String CounterpartyRegistrationNumber
    {
      get
      {
        return this._CounterpartyRegistrationNumber;
      }

      set
      {
        this.SetPropertyValue("CounterpartyRegistrationNumber", this._CounterpartyRegistrationNumber, value, (propertyValue) => { this._CounterpartyRegistrationNumber = propertyValue; }, this.CounterpartyRegistrationNumberChangedHandler);
      }
    }
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("Milestones"))
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Contracts.ContractualDocumentCreatingFromServerHandler", new object[] { (global::Sungero.Contracts.IContractualDocument)entitySource, this.Info });
      if (instance != null)
    ...
    protected void ContactChangedHandler()
    {
     ...
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).ContactChanged(args);
    }
    ...
    protected void ValidFromChangedHandler()
    {
     ...
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).ValidFromChanged(args);
    }
    ...
    protected void ValidTillChangedHandler()
    {
     ...
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).ValidTillChanged(args);
    }
    ...
    protected void ResponsibleEmployeeChangedHandler()
    {
     ...
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).ResponsibleEmployeeChanged(args);
    }
    ...
    protected void IsStandardChangedHandler()
    {
     ...
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).IsStandardChanged(args);
    }
    ...
    protected void MilestonesChangedHandler()
    {
     ...
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).MilestonesChanged(args);
    }

    protected void CounterpartyRegistrationNumberChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.StringPropertyChangedEventArgs(this.State.Properties.CounterpartyRegistrationNumber, this.CounterpartyRegistrationNumber, this);
     ((global::Sungero.Contracts.IContractualDocumentSharedHandlers)this.SharedHandlers).CounterpartyRegistrationNumberChanged(args);
    }
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.ContractualDocumentMilestonesSharedCollectionHandlers");
      if (type != null)
      {
        ...
        var methodInfo = type.GetMethod("MilestonesAdded");
    ...
    protected virtual void MilestonesDeletedHandler(object sender, global::Sungero.Domain.Shared.ChildEntityDeletedEventArgs<global::Sungero.Domain.Shared.IChildEntity> e)
    {
      ...
      if (type != null)
      {
        ...
        var methodInfo = type.GetMethod("MilestonesDeleted");
    ...
    protected override global::Sungero.Domain.Shared.EntityConvertingFromServerHandler CreateConvertingFromServerHandler(   
      global::Sungero.Domain.Shared.IEntity entitySource)
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Contracts.ContractualDocumentConvertingFromServerHandler", (global::Sungero.Content.IElectronicDocument)entitySource, this.Info);
      if (instance != null)
...
namespace Sungero.Contracts.Functions
{
  internal static class ContractualDocument
  {
    ...
    internal static  global::Sungero.Contracts.IContractualDocument GetIgnoreAccessRights(global::System.Int64 documentId)
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.Server.ContractualDocumentFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetIgnoreAccessRights",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::System.Int64) }, null);
        return (global::Sungero.Contracts.IContractualDocument)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { documentId });
      }
      else
      {
    ...
    internal static  global::System.String GetRegistrationNumberIgnoreAccessRights(global::System.Int64 documentId)
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.Server.ContractualDocumentFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetRegistrationNumberIgnoreAccessRights",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::System.Int64) }, null);
        return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { documentId });
      }
      else
      {
    ...
    internal static  global::System.String TotalAmountInCurrencyToWords(global::Sungero.Contracts.IContractualDocument contractualDocument)
    {
      ...
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("TotalAmountInCurrencyToWords",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Contracts.IContractualDocument) }, null);
        return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { contractualDocument });
      }
      else
      {
    ...
    /// <redirect project="Sungero.Contracts.Server" type="Sungero.Contracts.Server.ContractualDocumentFunctions" />
    [global::Sungero.Core.RemoteAttribute(IsPure = true)]
    internal static  global::System.Boolean HasSpecifiedTypeRelations(global::Sungero.Contracts.IContractualDocument contractualDocument)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)contractualDocument).FunctionsContainer.ServerFunctions;
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)contractualDocument).FunctionsContainer.SharedFunctions;
    ...
    /// <redirect project="Sungero.Contracts.Shared" type="Sungero.Contracts.Shared.ContractualDocumentFunctions" />
    internal static  global::System.Collections.Generic.List<global::Sungero.Docflow.Structures.OfficialDocument.IEmailAddressee> GetEmailAddressees(global::Sungero.Contracts.IContractualDocument contractualDocument)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)contractualDocument).FunctionsContainer.SharedFunctions;
    ...
    /// <redirect project="Sungero.Contracts.Shared" type="Sungero.Contracts.Shared.ContractualDocumentFunctions" />
    internal static  void ChangeRegistrationPaneVisibility(global::Sungero.Contracts.IContractualDocument contractualDocument, global::System.Boolean needShow, global::System.Boolean repeatRegister)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)contractualDocument).FunctionsContainer.SharedFunctions;
