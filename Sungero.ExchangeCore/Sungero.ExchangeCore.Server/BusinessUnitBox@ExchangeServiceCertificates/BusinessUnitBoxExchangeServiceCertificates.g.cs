...
namespace Sungero.ExchangeCore.Server
{
    ...
    where TRootEntity : class, global::Sungero.ExchangeCore.IBusinessUnitBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.BusinessUnitBoxExchangeServiceCertificatesCertificatePropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("ExchangeServiceCertificatesCertificateFiltering");
      ...
      {
        result = new global::Sungero.ExchangeCore.BusinessUnitBoxExchangeServiceCertificatesCertificatePropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).ExchangeServiceCertificatesCertificateFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.ICertificate
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.BusinessUnitBoxExchangeServiceCertificatesCertificateSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("ExchangeServiceCertificatesCertificateSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.ExchangeCore.BusinessUnitBoxExchangeServiceCertificatesCertificateSearchPropertyFilteringServerHandler<TQueryEntity>().ExchangeServiceCertificatesCertificateSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.ExchangeCore.IBusinessUnitBoxExchangeServiceCertificates
  {
    ...
    protected void CertificateChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IBusinessUnitBoxExchangeServiceCertificatesSharedHandlers)this.SharedHandlers).ExchangeServiceCertificatesCertificateChanged(args);
    }
