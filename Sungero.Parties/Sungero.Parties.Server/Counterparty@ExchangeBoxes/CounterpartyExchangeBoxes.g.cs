...
namespace Sungero.Parties.Server
{
    ...
    where TRootEntity : class, global::Sungero.Parties.ICounterparty
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Parties.CounterpartyExchangeBoxesBoxPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("ExchangeBoxesBoxFiltering");
      ...
      {
        result = new global::Sungero.Parties.CounterpartyExchangeBoxesBoxPropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).ExchangeBoxesBoxFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.ExchangeCore.IBusinessUnitBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Parties.CounterpartyExchangeBoxesBoxSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("ExchangeBoxesBoxSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.Parties.CounterpartyExchangeBoxesBoxSearchPropertyFilteringServerHandler<TQueryEntity>().ExchangeBoxesBoxSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.Parties.ICounterpartyExchangeBoxes
  {
    ...
    private global::System.String _CounterpartyParentBranchId;
    public virtual global::System.String CounterpartyParentBranchId
    {
      ...
      set
      {
        this.SetPropertyValue("CounterpartyParentBranchId", this._CounterpartyParentBranchId, value, (propertyValue) => { this._CounterpartyParentBranchId = propertyValue; }, this.CounterpartyParentBranchIdChangedHandler);
      }
    }
