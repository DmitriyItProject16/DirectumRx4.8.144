...
namespace Sungero.RecordManagement.Server
{
    ...
    public class IncomingLetterSearchDialogModel : global::Sungero.Docflow.Server.IncomingDocumentBaseSearchDialogModel
        {
                  ...
                  public virtual global::System.Collections.Generic.IEnumerable<Sungero.Parties.IContact> SignedBy { get; protected set; }
                   ...
                   public new IncomingLetterAddresseesModel Addressees { get { return (IncomingLetterAddresseesModel)base.Addressees; } protected set { base.Addressees = value; } }
      ...
      public class IncomingLetterAddresseesModel : global::Sungero.Docflow.Server.IncomingDocumentBaseAddresseesModel
          {
                      [Sungero.Domain.Shared.HideInDevStudio()]
                      public override global::System.Int64? Id { get; protected set; }


                      public override global::System.Collections.Generic.IEnumerable<global::Sungero.CoreEntities.IRecipient> Addressee { get; protected set; }
    ...
    where TSourceEntity : class, global::Sungero.RecordManagement.IIncomingLetter
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.IncomingLetterAddresseePropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.RecordManagement.IncomingLetterAddresseePropertyFilteringServerHandler<TQueryEntity>(sourceEntity).AddresseeFiltering(query, args);
      }
    ...
    where TSourceEntity : class, global::Sungero.RecordManagement.IIncomingLetter
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.IncomingLetterSignedByPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
        var methodInfo = genericType.GetMethod("SignedByFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.RecordManagement.IncomingLetterSignedByPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).SignedByFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.Parties.IContact
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.IncomingLetterSignedBySearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("SignedBySearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.RecordManagement.IncomingLetterSignedBySearchPropertyFilteringServerHandler<TQueryEntity>().SignedBySearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.RecordManagement.IIncomingLetter
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.IncomingLetterContactPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.RecordManagement.IncomingLetterContactPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).ContactFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.Parties.IContact
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.IncomingLetterContactSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
      ...
      {
        result = new global::Sungero.RecordManagement.IncomingLetterContactSearchPropertyFilteringServerHandler<TQueryEntity>().ContactSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Docflow.Server.IncomingDocumentBase, global::Sungero.RecordManagement.IIncomingLetter, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    protected override global::Sungero.Domain.Shared.IChildEntityCollection<global::Sungero.Docflow.IIncomingDocumentBaseAddressees> CreateAddresseesCollection()
    {
      return new global::Sungero.Domain.ChildEntityCollection<global::Sungero.RecordManagement.IIncomingLetterAddressees>() { RootEntity = this };
    }
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.RecordManagement.IncomingLetterCreatingFromServerHandler", new object[] { (global::Sungero.RecordManagement.IIncomingLetter)entitySource, this.Info });
      if (instance != null)
    ...
    protected override global::Sungero.Domain.Shared.EntityConvertingFromServerHandler CreateConvertingFromServerHandler(   
      global::Sungero.Domain.Shared.IEntity entitySource)
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.RecordManagement.IncomingLetterConvertingFromServerHandler", (global::Sungero.Content.IElectronicDocument)entitySource, this.Info);
      if (instance != null)
...
namespace Sungero.RecordManagement
{
    ...
    where T : class, global::Sungero.RecordManagement.IIncomingLetter
  {
    ...
    public override global::System.Linq.IQueryable<T> Filtering(global::System.Linq.IQueryable<T> query, global::Sungero.Domain.FilteringEventArgs e)
    {
      ...
      public override global::System.Linq.IQueryable<Sungero.Company.IEmployee> AddresseeFiltering(global::System.Linq.IQueryable<Sungero.Company.IEmployee> query, global::Sungero.Domain.FilteringEventArgs e)
      {
...
namespace Sungero.RecordManagement.Server
{
    ...
    public class IncomingLetterAddresseePanelNavigationFilter : global::Sungero.Docflow.Server.IncomingDocumentBaseAddresseePanelNavigationFilter
    {
      private global::System.Linq.IQueryable Apply<T>(global::System.Linq.IQueryable query) where T: class, global::Sungero.RecordManagement.IIncomingLetter
      {
...
namespace Sungero.RecordManagement.Functions
{
  internal static class IncomingLetter
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.Server.IncomingLetterFunctions");
      if (__funcType != null)
      {    
        ...
        return (global::System.Linq.IQueryable<global::Sungero.RecordManagement.IIncomingLetter>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { letter, documentKind, businessUnit, inNumber, dated, correspondent });
      }
      else
      {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)incomingLetter).FunctionsContainer.ServerFunctions;
    ...
    /// <redirect project="Sungero.RecordManagement.Server" type="Sungero.RecordManagement.Server.IncomingLetterFunctions" />
    internal static  global::System.String GetPropertyValue(global::Sungero.RecordManagement.IIncomingLetter incomingLetter, global::System.String propertyName)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)incomingLetter).FunctionsContainer.ServerFunctions;
