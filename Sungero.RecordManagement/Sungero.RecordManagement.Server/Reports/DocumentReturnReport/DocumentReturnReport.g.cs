...
{
  public class DocumentReturnReport : global::Sungero.Reporting.Server.Report, global::Sungero.RecordManagement.IDocumentReturnReport
  {
    ...
    protected override void FillDataSources(global::FastReport.Report report)
    {
      ...
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.DocumentReturnReportServerHandlers");
      if (type != null)
      {
      }
      else
    ...
    public DocumentReturnReport()
    {
      ...
      this.Handlers = type != null
        ...
        : new global::Sungero.RecordManagement.DocumentReturnReportServerHandlers(this);
    }
  }
}
...
{
  public partial class DocumentReturnReportServerHandlers : global::Sungero.Reporting.ReportServerHandlers
  {
    ...
    public DocumentReturnReportServerHandlers(global::Sungero.RecordManagement.IDocumentReturnReport report) : base(report) { }
  }
}
...
// ==================================================================
// DocumentReturnReportQueries.g.cs
// ==================================================================
...
{
  public class DocumentReturnReport
  {
    private static global::Sungero.Domain.SqlQueryResolver resolver = new global::Sungero.Domain.SqlQueryResolver("Sungero.RecordManagement.Server.Reports.DocumentReturnReport.DocumentReturnReportQueries.xml", System.Reflection.Assembly.GetExecutingAssembly());
    public static string SelectFromDocumentsReturnReportTable
    {
       get { return resolver.GetQuery("SelectFromDocumentsReturnReportTable"); }
    }
    public static string CreateDocumentsReturnReportTable
    {
       get { return resolver.GetQuery("CreateDocumentsReturnReportTable"); }
    }
  }
}
