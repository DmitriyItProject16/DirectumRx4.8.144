...
namespace Sungero.ExchangeCore.Server
{
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.IQueueItemBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.QueueItemBaseBoxPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.ExchangeCore.QueueItemBaseBoxPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).BoxFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.ExchangeCore.IBoxBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.QueueItemBaseBoxSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.ExchangeCore.QueueItemBaseBoxSearchPropertyFilteringServerHandler<TQueryEntity>().BoxSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TSourceEntity : class, global::Sungero.ExchangeCore.IQueueItemBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      var args = new global::Sungero.Domain.PropertyFilteringEventArgs(sourceEntity);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.QueueItemBaseRootBoxPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType, new object[] { sourceEntity });
      ...
      {
        result = new global::Sungero.ExchangeCore.QueueItemBaseRootBoxPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).RootBoxFiltering(query, args);
      }
      if (args.DisableUiFiltering)
        global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    where TQueryEntity : class, global::Sungero.ExchangeCore.IBusinessUnitBox
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      var args = new global::Sungero.Domain.PropertySearchDialogFilteringEventArgs(entityType);
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ExchangeCore.QueueItemBaseRootBoxSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
      ...
      {
        result = new global::Sungero.ExchangeCore.QueueItemBaseRootBoxSearchPropertyFilteringServerHandler<TQueryEntity>().RootBoxSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.ExchangeCore.IQueueItemBase
  {
    ...
    private global::System.String _AsyncHandlerId;
    public virtual global::System.String AsyncHandlerId
    {
      get
      {
        return this._AsyncHandlerId;
      }

      set
      {
        this.SetPropertyValue("AsyncHandlerId", this._AsyncHandlerId, value, (propertyValue) => { this._AsyncHandlerId = propertyValue; }, this.AsyncHandlerIdChangedHandler);
      }
    }
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.ExchangeCore.QueueItemBaseCreatingFromServerHandler", new object[] { (global::Sungero.ExchangeCore.IQueueItemBase)entitySource, this.Info });
      if (instance != null)
    ...
    protected void NameChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).NameChanged(args);
    }
    ...
    protected void ExternalIdChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).ExternalIdChanged(args);
    }
    ...
    protected void BoxChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).BoxChanged(args);
    }
    ...
    protected void RetriesChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).RetriesChanged(args);
    }

    protected void NoteChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.StringPropertyChangedEventArgs(this.State.Properties.Note, this.Note, this);
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).NoteChanged(args);
    }
    ...
    protected void ProcessingStatusChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).ProcessingStatusChanged(args);
    }
    ...
    protected void LastUpdateChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).LastUpdateChanged(args);
    }
    ...
    protected void RootBoxChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).RootBoxChanged(args);
    }

    protected void AsyncHandlerIdChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.StringPropertyChangedEventArgs(this.State.Properties.AsyncHandlerId, this.AsyncHandlerId, this);
     ((global::Sungero.ExchangeCore.IQueueItemBaseSharedHandlers)this.SharedHandlers).AsyncHandlerIdChanged(args);
    }
...
namespace Sungero.ExchangeCore.Functions
{
  internal static class QueueItemBase
  {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)queueItemBase).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("QueueItemOnError", new System.Type[] { typeof(global::System.String) });
    global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] { errorMessage });
    }
