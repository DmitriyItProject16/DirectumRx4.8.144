...
namespace Sungero.Docflow
{
  partial class ApprovalRuleCardReportServerHandlers
  {
    ...
    private Structures.ApprovalRuleCardReport.SignatureSettingsTableLine CreateSignatureSettingsTableLine(string displayValue, long id, string hyperlink, int orderNumber,
