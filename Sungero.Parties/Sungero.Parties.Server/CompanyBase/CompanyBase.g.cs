...
namespace Sungero.Parties.Server
{
    ...
    public class CompanyBaseSearchDialogModel : global::Sungero.Parties.Server.CounterpartySearchDialogModel
        {
                  ...
                  public virtual global::System.Collections.Generic.IEnumerable<Sungero.Core.Enumeration> Reliability { get; protected set; }
    ...
    where TSourceEntity : class, global::Sungero.Parties.ICompanyBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Parties.CompanyBaseHeadCompanyPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.Parties.CompanyBaseHeadCompanyPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).HeadCompanyFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.Parties.ICompany
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Parties.CompanyBaseHeadCompanySearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.Parties.CompanyBaseHeadCompanySearchPropertyFilteringServerHandler<TQueryEntity>().HeadCompanySearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Parties.Server.Counterparty, global::Sungero.Parties.ICompanyBase
  {
    ...
    private static global::Sungero.Domain.Shared.EnumerationItems _ReliabilityItems = new global::Sungero.Domain.Shared.EnumerationItems(
      null,
      typeof(global::Sungero.Parties.CompanyBase.Reliability),
      typeof(global::Sungero.Parties.Server.CompanyBase),
      "Reliability");

    public static global::Sungero.Domain.Shared.EnumerationItems ReliabilityItems
    {
      get { return global::Sungero.Parties.Server.CompanyBase._ReliabilityItems; }
    }

    public virtual global::Sungero.Domain.Shared.EnumerationItems ReliabilityAllowedItems
    {
      get { return global::Sungero.Parties.Server.CompanyBase.ReliabilityItems; }
    }

    private global::Sungero.Core.Enumeration? _Reliability;

    public virtual global::Sungero.Core.Enumeration? Reliability
    {
      get { return this._Reliability; }
      set { this.SetEnumPropertyValue("Reliability", this._Reliability, value, (propertyValue) => { this._Reliability = propertyValue; }, this.ReliabilityChangedHandler, this.ReliabilityAllowedItems); }
    }
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Parties.CompanyBaseCreatingFromServerHandler", new object[] { (global::Sungero.Parties.ICompanyBase)entitySource, this.Info });
      if (instance != null)
    ...
    protected void HeadCompanyChangedHandler()
    {
     ...
     ((global::Sungero.Parties.ICompanyBaseSharedHandlers)this.SharedHandlers).HeadCompanyChanged(args);
    }
    ...
    protected void TRRCChangedHandler()
    {
     ...
     ((global::Sungero.Parties.ICompanyBaseSharedHandlers)this.SharedHandlers).TRRCChanged(args);
    }
    ...
    protected void IsCardReadOnlyChangedHandler()
    {
     ...
     ((global::Sungero.Parties.ICompanyBaseSharedHandlers)this.SharedHandlers).IsCardReadOnlyChanged(args);
    }
    ...
    protected void LegalNameChangedHandler()
    {
     ...
     ((global::Sungero.Parties.ICompanyBaseSharedHandlers)this.SharedHandlers).LegalNameChanged(args);
    }


    protected void ReliabilityChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.EnumerationPropertyChangedEventArgs(this.State.Properties.Reliability, this.Reliability, this);
     ((global::Sungero.Parties.ICompanyBaseSharedHandlers)this.SharedHandlers).ReliabilityChanged(args);
    }
...
namespace Sungero.Parties.Functions
{
  internal static class CompanyBase
  {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)companyBase).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("FillFromService", new System.Type[] { typeof(global::System.String) });
      return (global::Sungero.Parties.Structures.CompanyBase.FoundCompanies)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] { specifiedPSRN });
    }
    /// <redirect project="Sungero.Parties.Server" type="Sungero.Parties.Server.CompanyBaseFunctions" />
    internal static  global::System.String GetFormatOkved(CompanyData.CompaniesDTO.CompanyDTO company)
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Parties.Server.CompanyBaseFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetFormatOkved",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(CompanyData.CompaniesDTO.CompanyDTO) }, null);
        return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { company });
      }
      else
      {
    ...
    /// <redirect project="Sungero.Parties.Server" type="Sungero.Parties.Server.CompanyBaseFunctions" />
    internal static  global::System.String GetIndexingJson(global::Sungero.Parties.ICompanyBase companyBase)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)companyBase).FunctionsContainer.ServerFunctions;
    ...
    /// <redirect project="Sungero.Parties.Server" type="Sungero.Parties.Server.CompanyBaseFunctions" />
    internal static  global::System.String PrepareEmailForIndex(global::Sungero.Parties.ICompanyBase companyBase, global::System.String email)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)companyBase).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("PrepareEmailForIndex", new System.Type[] { typeof(global::System.String) });
      return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] { email });
    }
    /// <redirect project="Sungero.Parties.Server" type="Sungero.Parties.Server.CompanyBaseFunctions" />
    internal static  global::System.String PrepareHomepageForIndex(global::Sungero.Parties.ICompanyBase companyBase, global::System.String homepage)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)companyBase).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("PrepareHomepageForIndex", new System.Type[] { typeof(global::System.String) });
      return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] { homepage });
    }
    /// <redirect project="Sungero.Parties.Server" type="Sungero.Parties.Server.CompanyBaseFunctions" />
    internal static  global::System.String PreparePhonesForIndex(global::Sungero.Parties.ICompanyBase companyBase, global::System.String phones)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)companyBase).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("PreparePhonesForIndex", new System.Type[] { typeof(global::System.String) });
      return (global::System.String)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] { phones });
    }
...
namespace Sungero.Parties.Server
{
  ...
  {
    public global::System.String GetIndexingJson(global::Sungero.Parties.ICompanyBase companyBase)
    {
      return global::Sungero.Parties.Functions.CompanyBase.GetIndexingJson(companyBase);
    }
  }
}
