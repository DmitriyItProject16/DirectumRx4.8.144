...
namespace Sungero.Company.Server
{
      ...
      where T : class, global::Sungero.Company.IVisibilityRule
    {
      ...
      protected override global::System.Linq.IQueryable<T> ApplyAppliedFilter(global::System.Linq.IQueryable<T> query)
      {
        ...
        var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Company.VisibilityRuleFilteringServerHandler`1");
        if (filterType != null)
        {
        ...
        {
          result = new global::Sungero.Company.VisibilityRuleFilteringServerHandler<T>(this.filter).Filtering(query, args);
        }
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.Company.IVisibilityRule, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("VisibleMembers"))
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("ExcludedMembers"))
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Company.VisibilityRuleCreatingFromServerHandler", new object[] { (global::Sungero.Company.IVisibilityRule)entitySource, this.Info });
      if (instance != null)
