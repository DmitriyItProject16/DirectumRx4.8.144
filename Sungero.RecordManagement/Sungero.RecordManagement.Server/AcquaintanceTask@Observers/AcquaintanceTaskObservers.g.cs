...
namespace Sungero.RecordManagement.Server
{
    ...
    where TRootEntity : class, global::Sungero.RecordManagement.IAcquaintanceTask
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.AcquaintanceTaskObserversObserverPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("ObserversObserverFiltering");
      ...
      {
        result = new global::Sungero.RecordManagement.AcquaintanceTaskObserversObserverPropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).ObserversObserverFiltering(query, args);
      }
