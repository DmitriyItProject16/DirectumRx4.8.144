...
namespace Sungero.Docflow.Server
{
    ...
    where TRootEntity : class, global::Sungero.Docflow.IAccessRightsRule
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.AccessRightsRuleDocumentGroupsDocumentGroupPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.Docflow.AccessRightsRuleDocumentGroupsDocumentGroupPropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).DocumentGroupsDocumentGroupFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.Docflow.IDocumentGroupBase
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.AccessRightsRuleDocumentGroupsDocumentGroupSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.Docflow.AccessRightsRuleDocumentGroupsDocumentGroupSearchPropertyFilteringServerHandler<TQueryEntity>().DocumentGroupsDocumentGroupSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.Docflow.IAccessRightsRuleDocumentGroups
  {
    ...
    protected void DocumentGroupChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IAccessRightsRuleDocumentGroupsSharedHandlers)this.SharedHandlers).DocumentGroupsDocumentGroupChanged(args);
    }
