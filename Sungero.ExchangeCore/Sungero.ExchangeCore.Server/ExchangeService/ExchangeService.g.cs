...
namespace Sungero.ExchangeCore.Server
{
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.ExchangeCore.IExchangeService
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.ExchangeCore.ExchangeServiceCreatingFromServerHandler", new object[] { (global::Sungero.ExchangeCore.IExchangeService)entitySource, this.Info });
      if (instance != null)
    ...
    protected void NameChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IExchangeServiceSharedHandlers)this.SharedHandlers).NameChanged(args);
    }
    ...
    protected void UriChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IExchangeServiceSharedHandlers)this.SharedHandlers).UriChanged(args);
    }

    protected void NoteChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.StringPropertyChangedEventArgs(this.State.Properties.Note, this.Note, this);
     ((global::Sungero.ExchangeCore.IExchangeServiceSharedHandlers)this.SharedHandlers).NoteChanged(args);
    }
    ...
    protected void ExchangeProviderChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IExchangeServiceSharedHandlers)this.SharedHandlers).ExchangeProviderChanged(args);
    }
    ...
    protected void LogonUrlChangedHandler()
    {
     ...
     ((global::Sungero.ExchangeCore.IExchangeServiceSharedHandlers)this.SharedHandlers).LogonUrlChanged(args);
    }
