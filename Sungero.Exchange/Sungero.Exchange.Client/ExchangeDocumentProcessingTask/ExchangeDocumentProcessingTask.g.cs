...
namespace Sungero.Exchange.Client
{
  ...
  {
    var args = new global::Sungero.Exchange.Client.ExchangeDocumentProcessingTaskCounterpartyDepartmentBoxValueInputEventArgs(this.CounterpartyDepartmentBox, value, this, this.Info.Properties.CounterpartyDepartmentBox);
    ((global::Sungero.Exchange.ExchangeDocumentProcessingTaskClientHandlers)this.Handlers).CounterpartyDepartmentBoxValueInput(args);
    return args.NewValue;
  }
    ...
    where T : class, global::Sungero.Exchange.IExchangeDocumentProcessingTask
  {
    ...
    private void Init()
    {
              ...
              .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.Company.IEmployee>(() => this.Entity.Id, typeof(T), "Addressee");
                  ...
                  this._CounterpartyDepartmentBoxCollectionPresenter = this.CreateCollectionPresenterForNavigationProperty<global::Sungero.ExchangeCore.ICounterpartyDepartmentBox>(global::System.Guid.Parse("50fc6b8e-271a-4af7-9cd8-18ebecd27264"));
