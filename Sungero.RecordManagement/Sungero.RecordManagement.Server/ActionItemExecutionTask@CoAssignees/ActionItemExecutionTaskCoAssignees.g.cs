...
namespace Sungero.RecordManagement.Server
{
    ...
    where TRootEntity : class, global::Sungero.RecordManagement.IActionItemExecutionTask
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.ActionItemExecutionTaskCoAssigneesAssigneePropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("CoAssigneesAssigneeFiltering");
      ...
      {
        result = new global::Sungero.RecordManagement.ActionItemExecutionTaskCoAssigneesAssigneePropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).CoAssigneesAssigneeFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.ActionItemExecutionTaskCoAssigneesAssigneeSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("CoAssigneesAssigneeSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.RecordManagement.ActionItemExecutionTaskCoAssigneesAssigneeSearchPropertyFilteringServerHandler<TQueryEntity>().CoAssigneesAssigneeSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.RecordManagement.IActionItemExecutionTaskCoAssignees
  {
    ...
    protected void AssigneeChangedHandler()
    {
     ...
     ((global::Sungero.RecordManagement.IActionItemExecutionTaskCoAssigneesSharedHandlers)this.SharedHandlers).CoAssigneesAssigneeChanged(args);
    }
    ...
    protected void AssignmentCreatedChangedHandler()
    {
     ...
     ((global::Sungero.RecordManagement.IActionItemExecutionTaskCoAssigneesSharedHandlers)this.SharedHandlers).CoAssigneesAssignmentCreatedChanged(args);
    }
