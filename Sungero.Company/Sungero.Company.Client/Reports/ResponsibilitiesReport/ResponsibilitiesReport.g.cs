...
namespace Sungero.Company.Client
{
  public class ResponsibilitiesReport : global::Sungero.Reporting.Client.Report, global::Sungero.Company.IResponsibilitiesReport
  {
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Company.ResponsibilitiesReportClientHandlers");
      this.Handlers = type != null
        ? global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this })
        : new global::Sungero.Company.ResponsibilitiesReportClientHandlers(this);
    }
  }
}
