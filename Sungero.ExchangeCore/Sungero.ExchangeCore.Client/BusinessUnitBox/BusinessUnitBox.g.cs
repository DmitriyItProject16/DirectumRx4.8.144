...
namespace Sungero.ExchangeCore.Client
{
    ...
    global::Sungero.ExchangeCore.Client.BoxBase, global::Sungero.ExchangeCore.IBusinessUnitBox
  {
    ...
    protected override global::Sungero.Domain.Shared.IEntityAccessRights CreateAccessRights()
    {
      return new global::Sungero.ExchangeCore.Client.BusinessUnitBoxAccessRights(this);
        ...
        public virtual global::System.String FtsId
        {
          ...
          protected global::Sungero.Domain.Client.IListProperty<global::Sungero.ExchangeCore.IBusinessUnitBoxFormalizedPoAInfos> _FormalizedPoAInfos;

          virtual public global::Sungero.Domain.Shared.IChildEntityCollection<global::Sungero.ExchangeCore.IBusinessUnitBoxFormalizedPoAInfos> FormalizedPoAInfos
          {
            get { return this._FormalizedPoAInfos.Value; }
          }
    ...
    private object _FormalizedPoAInfosActionsHandlers;

    public object FormalizedPoAInfosActionsHandlers
    {
      get
      {
        if (this._FormalizedPoAInfosActionsHandlers == null)
          this._FormalizedPoAInfosActionsHandlers = this.CreateFormalizedPoAInfosActionsHandlers();
        return this._FormalizedPoAInfosActionsHandlers;
      }
    }

    private object _FormalizedPoAInfosCollectionActionsHandlers;

    public object FormalizedPoAInfosCollectionActionsHandlers
    {
      get
      {
        if (this._FormalizedPoAInfosCollectionActionsHandlers == null)
          this._FormalizedPoAInfosCollectionActionsHandlers = this.CreateFormalizedPoAInfosCollectionActionsHandlers();
        return this._FormalizedPoAInfosCollectionActionsHandlers;
      }
    }
    ...
    protected virtual object CreateExchangeServiceCertificatesActionsHandlers()
    {
      return null;
    }

    protected virtual object CreateExchangeServiceCertificatesCollectionActionsHandlers()
    {
      return null;
    }
    protected virtual object CreateFormalizedPoAInfosActionsHandlers()
    {
      return null;
    }

    protected virtual object CreateFormalizedPoAInfosCollectionActionsHandlers()
    {
      return null;
    }
  ...
  protected global::Sungero.CoreEntities.ICertificate CertificateReceiptNotificationsValueInputHandler(global::Sungero.CoreEntities.ICertificate value)
  {
    ...
    #region Constructors
            ...
            protected virtual void InitFormalizedPoAInfosCollectionProperty()
            {
              this._FormalizedPoAInfos = new global::Sungero.Domain.Client.ListProperty<global::Sungero.ExchangeCore.IBusinessUnitBoxFormalizedPoAInfos>("FormalizedPoAInfos", this);
              this._FormalizedPoAInfos.ValueChanged += (sender, e) => { this.FormalizedPoAInfosChangedHandler(); };
              this.AddProperty((global::Sungero.Domain.Client.IProperty)this._FormalizedPoAInfos);
              this.SetFormalizedPoAInfosEventHandlers();
            }

            protected void SetFormalizedPoAInfosEventHandlers()
            {
              this._FormalizedPoAInfos.ChildEntityAdded += this.FormalizedPoAInfosAddedHandler;
              this._FormalizedPoAInfos.ChildEntityDeleted += this.FormalizedPoAInfosDeletedHandler;
            }
    ...
    public BusinessUnitBox()
    {
            ...
            this.InitFormalizedPoAInfosCollectionProperty();
...
namespace Sungero.ExchangeCore.Client
{
    ...
    where T : class, global::Sungero.ExchangeCore.IBusinessUnitBox
  {
    #region Fields and properties
          ...
          private global::System.Windows.Input.ICommand _ShowMessageQueueItemCommand;

          public global::System.Windows.Input.ICommand ShowMessageQueueItemCommand
          {
            get
            {
              if (this._ShowMessageQueueItemCommand == null)
                  this._ShowMessageQueueItemCommand = new global::Sungero.Domain.Client.SingleEntityCommand<T>("ShowMessageQueueItem", this, this.ShowMessageQueueItem, this.CanShowMessageQueueItem) { IsEmptyParameterAllowed = true };
              return this._ShowMessageQueueItemCommand;
            }
          }
          private global::System.Windows.Input.ICommand _FindDocumentCommand;

          public global::System.Windows.Input.ICommand FindDocumentCommand
          {
            get
            {
              if (this._FindDocumentCommand == null)
                  this._FindDocumentCommand = new global::Sungero.Domain.Client.SingleEntityCommand<T>("FindDocument", this, this.FindDocument, this.CanFindDocument) { IsEmptyParameterAllowed = true };
              return this._FindDocumentCommand;
            }
          }
    ...
    #region Methods
              ...
              private bool CanShowMessageQueueItem(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfCanExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this);
                return ((Sungero.ExchangeCore.Client.BusinessUnitBoxActions)(entity as Sungero.ExchangeCore.Client.BusinessUnitBox).ActionsHandlers).CanShowMessageQueueItem(args);
              }

              private void ShowMessageQueueItem(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this, entity.Info.Actions.ShowMessageQueueItem);
                ((Sungero.ExchangeCore.Client.BusinessUnitBoxActions)(entity as Sungero.ExchangeCore.Client.BusinessUnitBox).ActionsHandlers).ShowMessageQueueItem(args);
              }
              private bool CanFindDocument(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfCanExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this);
                return ((Sungero.ExchangeCore.Client.BusinessUnitBoxActions)(entity as Sungero.ExchangeCore.Client.BusinessUnitBox).ActionsHandlers).CanFindDocument(args);
              }

              private void FindDocument(T entity)
              {
                var args = new global::Sungero.Domain.Client.WpfExecuteActionArgs(global::Sungero.Domain.Shared.FormType.Card, entity, this, entity.Info.Actions.FindDocument);
                ((Sungero.ExchangeCore.Client.BusinessUnitBoxActions)(entity as Sungero.ExchangeCore.Client.BusinessUnitBox).ActionsHandlers).FindDocument(args);
              }
