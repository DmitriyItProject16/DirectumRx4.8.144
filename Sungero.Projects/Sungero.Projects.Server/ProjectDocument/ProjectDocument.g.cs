...
namespace Sungero.Projects.Server
{
    ...
    global::Sungero.Docflow.Server.InternalDocumentBase, global::Sungero.Projects.IProjectDocument, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Projects.ProjectDocumentCreatingFromServerHandler", new object[] { (global::Sungero.Projects.IProjectDocument)entitySource, this.Info });
      if (instance != null)
    ...
    protected override global::Sungero.Domain.Shared.EntityConvertingFromServerHandler CreateConvertingFromServerHandler(   
      global::Sungero.Domain.Shared.IEntity entitySource)
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Projects.ProjectDocumentConvertingFromServerHandler", (global::Sungero.Content.IElectronicDocument)entitySource, this.Info);
      if (instance != null)
...
namespace Sungero.Projects.Functions
{
  ...
  {
    /// <redirect project="Sungero.Projects.Server" type="Sungero.Projects.Server.ProjectDocumentFunctions" />
    internal static  global::Sungero.Company.IEmployee GetDefaultSignatory(global::Sungero.Projects.IProjectDocument projectDocument)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)projectDocument).FunctionsContainer.ServerFunctions;
