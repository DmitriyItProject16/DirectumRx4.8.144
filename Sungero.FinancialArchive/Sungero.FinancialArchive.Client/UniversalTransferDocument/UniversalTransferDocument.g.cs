...
namespace Sungero.FinancialArchive.Client
{
  public class UniversalTransferDocument :
    global::Sungero.Docflow.Client.AccountingDocumentBase, global::Sungero.FinancialArchive.IUniversalTransferDocument
  {
    ...
    {
      get { return global::Sungero.FinancialArchive.Client.UniversalTransferDocument.ClassTypeGuid; }
    }
    ...
    public new global::Sungero.FinancialArchive.IUniversalTransferDocumentState State
    {
      get
      {
        return (global::Sungero.FinancialArchive.IUniversalTransferDocumentState)base.State;
      }
    }
    ...
    public new global::Sungero.FinancialArchive.IUniversalTransferDocumentInfo Info
    {
      get
      {
        return (global::Sungero.FinancialArchive.IUniversalTransferDocumentInfo)base.Info;
      }
    }
    ...
    public new global::Sungero.FinancialArchive.IUniversalTransferDocumentAccessRights AccessRights
    {
      get
      {
        return (global::Sungero.FinancialArchive.IUniversalTransferDocumentAccessRights)base.AccessRights;
      }
    }

    protected override global::Sungero.Domain.Shared.IEntityAccessRights CreateAccessRights()
    {
      return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentAccessRights(this);
    }
    ...
    {
      return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentActions(this);
    }

    protected override object CreateCollectionActionsHandlers()
    {
      return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentCollectionActions();
    }

    protected override object CreateAnyChildEntityActionsHandlers()
    {
      return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentAnyChildEntityActions();
    }

    protected override object CreateAnyChildEntityCollectionActionsHandlers()
    {
      return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentAnyChildEntityCollectionActions();
    }


    protected override global::Sungero.Domain.Client.EntityFunctions CreateClientFunctions()
    {
      return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentFunctions(this);
    }
    ...
    protected override object CreateHandlers() {
      return new global::Sungero.FinancialArchive.UniversalTransferDocumentClientHandlers(this);
    }
    ...
    #region Constructors
            ...
            {
              this._Versions = new global::Sungero.Domain.Client.ListProperty<global::Sungero.FinancialArchive.IUniversalTransferDocumentVersions>("Versions", this);
            ...
            {
              this._Tracking = new global::Sungero.Domain.Client.ListProperty<global::Sungero.FinancialArchive.IUniversalTransferDocumentTracking>("Tracking", this);
...
// ==================================================================
// UniversalTransferDocumentPresenter.g.cs
// ==================================================================
...
namespace Sungero.FinancialArchive.Client
{
  public class UniversalTransferDocumentPresenter<T> :
    ...
    where T : class, global::Sungero.FinancialArchive.IUniversalTransferDocument
  {
    ...
    private void Init()
    {
              ...
              .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationProperty<global::Sungero.Docflow.IAccountingDocumentBase>(() => this.Entity, typeof(T), "Corrected");
                        ...
                        .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.CoreEntities.IUser>(() => this.Entity.Id, typeof(Sungero.FinancialArchive.IUniversalTransferDocumentVersions), "Author");

                        this._VersionsModifiedByCollectionPresenter
                        .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.CoreEntities.IUser>(() => this.Entity.Id, typeof(Sungero.FinancialArchive.IUniversalTransferDocumentVersions), "ModifiedBy");

                        this._VersionsAssociatedApplicationCollectionPresenter
                        .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.Content.IAssociatedApplication>(() => this.Entity.Id, typeof(Sungero.FinancialArchive.IUniversalTransferDocumentVersions), "AssociatedApplication");

                        this._VersionsBodyAssociatedApplicationCollectionPresenter
                        .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.Content.IAssociatedApplication>(() => this.Entity.Id, typeof(Sungero.FinancialArchive.IUniversalTransferDocumentVersions), "BodyAssociatedApplication");


                        this._TrackingDeliveredToCollectionPresenter
                        .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.Company.IEmployee>(() => this.Entity.Id, typeof(Sungero.FinancialArchive.IUniversalTransferDocumentTracking), "DeliveredTo");

                        this._TrackingReturnTaskCollectionPresenter
                        .Query = global::Sungero.Domain.Client.Session.GetValuesForNavigationPropertyWithoutSourceEntity<global::Sungero.Workflow.ITask>(() => this.Entity.Id, typeof(Sungero.FinancialArchive.IUniversalTransferDocumentTracking), "ReturnTask");



    }

    public UniversalTransferDocumentPresenter()
    {
      this.Init();
    }
...
// ==================================================================
// UniversalTransferDocumentCollectionPresenter.g.cs
// ==================================================================
...
namespace Sungero.FinancialArchive.Client
{
  public class UniversalTransferDocumentCollectionPresenter<T> : 
    ...
    where T: class, global::Sungero.FinancialArchive.IUniversalTransferDocument
  {
    ...
    public UniversalTransferDocumentCollectionPresenter(global::System.Linq.IQueryable<T> query, OnLookup onLookup)
      : base(query, onLookup)
    {
    }

    public UniversalTransferDocumentCollectionPresenter(global::System.Linq.IQueryable<T> query)
      : this(query, null) { }

    public UniversalTransferDocumentCollectionPresenter(OnLookup onLookup)
      : this(null, onLookup) { }

    public UniversalTransferDocumentCollectionPresenter()
      : this(null, null) { }
  }
}
...
{ 
  public class UniversalTransferDocumentRepositoryImplementer<T> : 
      ...
      where T : global::Sungero.FinancialArchive.IUniversalTransferDocument
    {
       ...
       protected override global::Sungero.Domain.Shared.IEntityAccessRights CreateAccessRights()
       {
         return new global::Sungero.FinancialArchive.Client.UniversalTransferDocumentTypeAccessRights(typeof(T));
       }
    }
}
...
namespace Sungero.FinancialArchive.Client
{
  public class UniversalTransferDocumentAccessRights : 
    Sungero.Docflow.Client.AccountingDocumentBaseAccessRights, Sungero.FinancialArchive.IUniversalTransferDocumentAccessRights
  {
  ...
  public class UniversalTransferDocumentTypeAccessRights : 
    Sungero.Docflow.Client.AccountingDocumentBaseTypeAccessRights, Sungero.FinancialArchive.IUniversalTransferDocumentAccessRights
  {
