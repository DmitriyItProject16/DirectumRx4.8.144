...
namespace Sungero.Company.Server
{
    ...
    where TRootEntity : class, global::Sungero.Company.IVisibilityRule
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Company.VisibilityRuleVisibleMembersRecipientPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("VisibleMembersRecipientFiltering");
      ...
      {
        result = new global::Sungero.Company.VisibilityRuleVisibleMembersRecipientPropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).VisibleMembersRecipientFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Company.VisibilityRuleVisibleMembersRecipientSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("VisibleMembersRecipientSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.Company.VisibilityRuleVisibleMembersRecipientSearchPropertyFilteringServerHandler<TQueryEntity>().VisibleMembersRecipientSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Domain.ChildEntity, global::Sungero.Company.IVisibilityRuleVisibleMembers
  {
    ...
    protected void RecipientChangedHandler()
    {
     ...
     ((global::Sungero.Company.IVisibilityRuleVisibleMembersSharedHandlers)this.SharedHandlers).VisibleMembersRecipientChanged(args);
    }
