...
namespace Sungero.Projects.Server
{
    ...
    global::Sungero.Docflow.Server.ApprovalRoleBase, global::Sungero.Projects.IProjectApprovalRole
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Projects.ProjectApprovalRoleCreatingFromServerHandler", new object[] { (global::Sungero.Projects.IProjectApprovalRole)entitySource, this.Info });
      if (instance != null)
...
namespace Sungero.Projects.Functions
{
  internal static class ProjectApprovalRole
  {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)projectApprovalRole).FunctionsContainer.ServerFunctions;
