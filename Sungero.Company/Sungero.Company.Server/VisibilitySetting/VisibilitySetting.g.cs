...
namespace Sungero.Company.Server
{
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.Company.IVisibilitySetting
  {
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("UnrestrictedRecipients"))
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("HiddenRecipients"))
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Company.VisibilitySettingCreatingFromServerHandler", new object[] { (global::Sungero.Company.IVisibilitySetting)entitySource, this.Info });
      if (instance != null)
    ...
    protected void NameChangedHandler()
    {
     ...
     ((global::Sungero.Company.IVisibilitySettingSharedHandlers)this.SharedHandlers).NameChanged(args);
    }
    ...
    protected void NeedRestrictVisibilityChangedHandler()
    {
     ...
     ((global::Sungero.Company.IVisibilitySettingSharedHandlers)this.SharedHandlers).NeedRestrictVisibilityChanged(args);
    }

    protected void UnrestrictedRecipientsChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.CollectionPropertyChangedEventArgs(this);
     ((global::Sungero.Company.IVisibilitySettingSharedHandlers)this.SharedHandlers).UnrestrictedRecipientsChanged(args);
    }
    ...
    protected void NeedRestrictVisibilityDescriptionChangedHandler()
    {
     ...
     ((global::Sungero.Company.IVisibilitySettingSharedHandlers)this.SharedHandlers).NeedRestrictVisibilityDescriptionChanged(args);
    }

    protected void HiddenRecipientsChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.CollectionPropertyChangedEventArgs(this);
     ((global::Sungero.Company.IVisibilitySettingSharedHandlers)this.SharedHandlers).HiddenRecipientsChanged(args);
    }
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Company.VisibilitySettingUnrestrictedRecipientsSharedCollectionHandlers");
      if (type != null)
      {
        ...
        var methodInfo = type.GetMethod("UnrestrictedRecipientsAdded");
    ...
    protected virtual void UnrestrictedRecipientsDeletedHandler(object sender, global::Sungero.Domain.Shared.ChildEntityDeletedEventArgs<global::Sungero.Domain.Shared.IChildEntity> e)
    {
      ...
      if (type != null)
      {
        ...
        var methodInfo = type.GetMethod("UnrestrictedRecipientsDeleted");
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Company.VisibilitySettingHiddenRecipientsSharedCollectionHandlers");
      if (type != null)
      {
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this, e.Value, null, e.Source });
        var methodInfo = type.GetMethod("HiddenRecipientsAdded");
        var args = new global::Sungero.Domain.Shared.CollectionPropertyAddedEventArgs(this);
        global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { args });
      }
      else
    ...
    protected virtual void HiddenRecipientsDeletedHandler(object sender, global::Sungero.Domain.Shared.ChildEntityDeletedEventArgs<global::Sungero.Domain.Shared.IChildEntity> e)
    {
      ...
      {
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this, null, e.Value, null });
        var methodInfo = type.GetMethod("HiddenRecipientsDeleted");
        var args = new global::Sungero.Domain.Shared.CollectionPropertyDeletedEventArgs(this);
        global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { args });
      }
      else
