...
namespace Sungero.Docflow.Server
{
    ...
    where TSourceEntity : class, global::Sungero.Docflow.IRegistrationSetting
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.RegistrationSettingDocumentRegisterPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.Docflow.RegistrationSettingDocumentRegisterPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).DocumentRegisterFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.Docflow.IDocumentRegister
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.RegistrationSettingDocumentRegisterSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.Docflow.RegistrationSettingDocumentRegisterSearchPropertyFilteringServerHandler<TQueryEntity>().DocumentRegisterSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.Docflow.IRegistrationSetting
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.Docflow.RegistrationSettingCreatingFromServerHandler", new object[] { (global::Sungero.Docflow.IRegistrationSetting)entitySource, this.Info });
      if (instance != null)
    ...
    protected void NameChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).NameChanged(args);
    }
    ...
    protected void DocumentFlowChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).DocumentFlowChanged(args);
    }

    protected void DocumentKindsChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.CollectionPropertyChangedEventArgs(this);
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).DocumentKindsChanged(args);
    }

    protected void BusinessUnitsChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.CollectionPropertyChangedEventArgs(this);
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).BusinessUnitsChanged(args);
    }

    protected void DepartmentsChangedHandler()
    {
      var args = new global::Sungero.Domain.Shared.CollectionPropertyChangedEventArgs(this);
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).DepartmentsChanged(args);
    }
    ...
    protected void DocumentRegisterChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).DocumentRegisterChanged(args);
    }
    ...
    protected void PriorityChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).PriorityChanged(args);
    }
    ...
    protected void SettingTypeChangedHandler()
    {
     ...
     ((global::Sungero.Docflow.IRegistrationSettingSharedHandlers)this.SharedHandlers).SettingTypeChanged(args);
    }
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.RegistrationSettingDocumentKindsSharedCollectionHandlers");
      if (type != null)
      {
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.RegistrationSettingBusinessUnitsSharedCollectionHandlers");
      if (type != null)
      {
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this, e.Value, null, e.Source });
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.RegistrationSettingDepartmentsSharedCollectionHandlers");
      if (type != null)
      {
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this, e.Value, null, e.Source });
...
namespace Sungero.Docflow.Functions
{
  internal static class RegistrationSetting
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Docflow.Server.RegistrationSettingFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetDoubleSettings",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Docflow.IRegistrationSetting) }, null);
        return (global::System.Collections.Generic.List<global::Sungero.Docflow.IRegistrationSetting>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { setting });
      }
      else
      {
    ...
    internal static  global::System.Linq.IQueryable<global::Sungero.Docflow.IRegistrationSetting> GetRegistrationSettingsByDocumentKind(global::Sungero.Docflow.IDocumentKind documentKind)
    {
      ...
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("GetRegistrationSettingsByDocumentKind",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Docflow.IDocumentKind) }, null);
        return (global::System.Linq.IQueryable<global::Sungero.Docflow.IRegistrationSetting>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { documentKind });
      }
      else
      {
