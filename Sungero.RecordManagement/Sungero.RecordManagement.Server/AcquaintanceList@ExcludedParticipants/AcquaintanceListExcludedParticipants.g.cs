...
namespace Sungero.RecordManagement.Server
{
    ...
    where TRootEntity : class, global::Sungero.RecordManagement.IAcquaintanceList
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity, TRootEntity rootEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.AcquaintanceListExcludedParticipantsExcludedParticipantPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("ExcludedParticipantsExcludedParticipantFiltering");
      ...
      {
        result = new global::Sungero.RecordManagement.AcquaintanceListExcludedParticipantsExcludedParticipantPropertyFilteringServerHandler<TQueryEntity>(sourceEntity, rootEntity).ExcludedParticipantsExcludedParticipantFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.AcquaintanceListExcludedParticipantsExcludedParticipantSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("ExcludedParticipantsExcludedParticipantSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.RecordManagement.AcquaintanceListExcludedParticipantsExcludedParticipantSearchPropertyFilteringServerHandler<TQueryEntity>().ExcludedParticipantsExcludedParticipantSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
