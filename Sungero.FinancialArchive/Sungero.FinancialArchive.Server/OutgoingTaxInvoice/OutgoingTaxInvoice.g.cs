...
namespace Sungero.FinancialArchive.Server
{
    ...
    where TSourceEntity : class, global::Sungero.FinancialArchive.IOutgoingTaxInvoice
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.FinancialArchive.OutgoingTaxInvoiceCorrectedPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.FinancialArchive.OutgoingTaxInvoiceCorrectedPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).CorrectedFiltering(query, args);
      }
    ...
    global::Sungero.Docflow.Server.AccountingDocumentBase, global::Sungero.FinancialArchive.IOutgoingTaxInvoice, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.FinancialArchive.OutgoingTaxInvoiceCreatingFromServerHandler", new object[] { (global::Sungero.FinancialArchive.IOutgoingTaxInvoice)entitySource, this.Info });
      if (instance != null)
    ...
    protected override global::Sungero.Domain.Shared.EntityConvertingFromServerHandler CreateConvertingFromServerHandler(   
      global::Sungero.Domain.Shared.IEntity entitySource)
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.FinancialArchive.OutgoingTaxInvoiceConvertingFromServerHandler", (global::Sungero.Content.IElectronicDocument)entitySource, this.Info);
      if (instance != null)
