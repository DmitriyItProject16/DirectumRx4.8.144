...
namespace Sungero.SmartProcessing.Server
{
    ...
    public class BlobPackageSearchDialogModel : global::Sungero.CoreEntities.Server.DatabookEntrySearchDialogModel
        {
                  ...
                  public virtual global::System.String SourceName { get; protected set; }
                  public virtual global::System.String MessageId { get; protected set; }
                  public virtual global::System.String Priority { get; protected set; }
                  ...
                  public virtual global::System.Collections.Generic.IEnumerable<CommonLibrary.DateRangeValue> DcsProcessingBeginDate { get; protected set; }
                  public virtual global::System.Collections.Generic.IEnumerable<CommonLibrary.DateRangeValue> SendDate { get; protected set; }
    ...
    where TSourceEntity : class, global::Sungero.SmartProcessing.IBlobPackage
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.SmartProcessing.BlobPackageMailBodyBlobPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        ...
        var methodInfo = genericType.GetMethod("MailBodyBlobFiltering");
      ...
      {
        result = new global::Sungero.SmartProcessing.BlobPackageMailBodyBlobPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).MailBodyBlobFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.SmartProcessing.IBlob
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.SmartProcessing.BlobPackageMailBodyBlobSearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
        var instance = global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(genericType);
        var methodInfo = genericType.GetMethod("MailBodyBlobSearchDialogFiltering");
        result = (global::System.Linq.IQueryable<TQueryEntity>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(methodInfo, instance, new object[] { query, args });
      }
      else
      {
        result = new global::Sungero.SmartProcessing.BlobPackageMailBodyBlobSearchPropertyFilteringServerHandler<TQueryEntity>().MailBodyBlobSearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.CoreEntities.Server.DatabookEntry, global::Sungero.SmartProcessing.IBlobPackage
  {
    ...
    public virtual global::System.String PackageId
    {
      ...
      set
      {
        this.SetPropertyValue("PackageId", this._PackageId, value, (propertyValue) => { this._PackageId = propertyValue; }, this.PackageIdChangedHandler);
      }
    }
    ...
    public virtual global::System.String SourceName
    {
      ...
      set
      {
        this.SetPropertyValue("SourceName", this._SourceName, value, (propertyValue) => { this._SourceName = propertyValue; }, this.SourceNameChangedHandler);
      }
    }
    private global::System.DateTime? _DcsProcessingBeginDate;
    public virtual global::System.DateTime? DcsProcessingBeginDate
    {
      get
      {
        return this._DcsProcessingBeginDate;
      }

      set
      {
        this.SetPropertyValue("DcsProcessingBeginDate", this._DcsProcessingBeginDate, value, (propertyValue) => { this._DcsProcessingBeginDate = propertyValue; }, this.DcsProcessingBeginDateChangedHandler);
      }
    }
    ...
    public virtual global::System.String MessageId
    {
      ...
      set
      {
        this.SetPropertyValue("MessageId", this._MessageId, value, (propertyValue) => { this._MessageId = propertyValue; }, this.MessageIdChangedHandler);
      }
    }
    ...
    public virtual global::System.DateTime? SendDate
    {
      ...
      set
      {
        this.SetPropertyValue("SendDate", this._SendDate, value, (propertyValue) => { this._SendDate = propertyValue; }, this.SendDateChangedHandler);
      }
    }
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("Blobs"))
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("To"))
    ...
    {
      if (this.IsPropertyChangedHandlerEnabled && this.IsPropertyChangedAppliedHandlerEnabled("CC"))
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.SmartProcessing.BlobPackageCreatingFromServerHandler", new object[] { (global::Sungero.SmartProcessing.IBlobPackage)entitySource, this.Info });
      if (instance != null)
...
namespace Sungero.SmartProcessing.Functions
{
  internal static class BlobPackage
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.SmartProcessing.Server.BlobPackageFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("CreateBlobPackage",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] {  }, null);
        return (global::Sungero.SmartProcessing.IBlobPackage)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] {  });
      }
      else
      {
    ...
    /// <redirect project="Sungero.SmartProcessing.Server" type="Sungero.SmartProcessing.Server.BlobPackageFunctions" />
    internal static  void FillMailInfoFromDcsPackage(global::Sungero.SmartProcessing.IBlobPackage blobPackage, global::Sungero.SmartProcessing.Structures.Module.IDcsPackage source)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)blobPackage).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("FillMailInfoFromDcsPackage", new System.Type[] { typeof(global::Sungero.SmartProcessing.Structures.Module.IDcsPackage) });
    global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] { source });
    }
    /// <redirect project="Sungero.SmartProcessing.Server" type="Sungero.SmartProcessing.Server.BlobPackageFunctions" />
    internal static  global::Sungero.SmartProcessing.Structures.Module.IMailInfo CreateMailInfo(global::Sungero.SmartProcessing.IBlobPackage blobPackage)
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)blobPackage).FunctionsContainer.ServerFunctions;
      var __funcMethod = __functions.GetType().GetMethod("CreateMailInfo", new System.Type[] {  });
      return (global::Sungero.SmartProcessing.Structures.Module.IMailInfo)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, __functions, new object[] {  });
    }
...
namespace Sungero.SmartProcessing.Server
{
  ...
  {
    public global::Sungero.SmartProcessing.Structures.Module.IMailInfo CreateMailInfo(global::Sungero.SmartProcessing.IBlobPackage blobPackage)
    {
      return global::Sungero.SmartProcessing.Functions.BlobPackage.CreateMailInfo(blobPackage);
    }
    public void FillMailInfoFromDcsPackage(global::Sungero.SmartProcessing.IBlobPackage blobPackage, global::Sungero.SmartProcessing.Structures.Module.IDcsPackage source)
    {
global::Sungero.SmartProcessing.Functions.BlobPackage.FillMailInfoFromDcsPackage(blobPackage, source);
    }
  }
}
