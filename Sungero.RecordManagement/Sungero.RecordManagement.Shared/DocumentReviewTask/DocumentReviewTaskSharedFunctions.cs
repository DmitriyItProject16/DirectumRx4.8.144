  ...
  partial class DocumentReviewTaskFunctions
  {
                                                      ...
                                                      IActionItemExecutionTask actionItem)
    {
      if (actionItem != null)
      {
        ...
        var addedAddenda = this.GetAddedAddenda();
        var removedAddenda = this.GetRemovedAddenda();
        Functions.Module.SynchronizeAttachmentsToActionItem(primaryDocument, addenda, addedAddenda, removedAddenda, otherAttachments, actionItem);
      }
    }
