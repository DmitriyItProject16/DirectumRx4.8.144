...
namespace Sungero.RecordManagement.Server
{
    ...
    where TSourceEntity : class, global::Sungero.RecordManagement.IActionItemSupervisorAssignment
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, TSourceEntity sourceEntity)
    {
      ...
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.ActionItemSupervisorAssignmentAssignedByPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
      ...
      {
        result = new global::Sungero.RecordManagement.ActionItemSupervisorAssignmentAssignedByPropertyFilteringServerHandler<TQueryEntity>(sourceEntity).AssignedByFiltering(query, args);
      }
    ...
    where TQueryEntity : class, global::Sungero.CoreEntities.IRecipient
  {
    protected override global::System.Linq.IQueryable<TQueryEntity> ApplyAppliedFilter(global::System.Linq.IQueryable<TQueryEntity> query, System.Guid entityType)
    {
      ...
      global::System.Linq.IQueryable<TQueryEntity> result;
      var filterType = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.RecordManagement.ActionItemSupervisorAssignmentAssignedBySearchPropertyFilteringServerHandler`1");
      if (filterType != null)
      {
        var genericType = filterType.MakeGenericType(typeof(TQueryEntity));
      ...
      {
        result = new global::Sungero.RecordManagement.ActionItemSupervisorAssignmentAssignedBySearchPropertyFilteringServerHandler<TQueryEntity>().AssignedBySearchDialogFiltering(query, args);
      }
      if (args.DisableUiFiltering)
          global::Sungero.Domain.UiFilteringEventManagementScope.DisableEvent<TQueryEntity>();
      return result;
    ...
    global::Sungero.Workflow.Server.Assignment, global::Sungero.RecordManagement.IActionItemSupervisorAssignment, global::Sungero.Domain.Shared.ISecurableEntity, global::Sungero.Domain.IInternalSecurableEntity
  {
    ...
    {
      var instance = Sungero.Metadata.Services.AppliedTypesManager.CreateInstance("Sungero.RecordManagement.ActionItemSupervisorAssignmentCreatingFromServerHandler", new object[] { (global::Sungero.RecordManagement.IActionItemSupervisorAssignment)entitySource, this.Info });
      if (instance != null)
...
namespace Sungero.RecordManagement.Functions
{
  internal static class ActionItemSupervisorAssignment
  {
    ...
    {
      var __functions = ((global::Sungero.Domain.Shared.IEntityFunctions)actionItemSupervisorAssignment).FunctionsContainer.ServerFunctions;
